                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-12">
                                                   <div class="sn-field password-holder mb-3">
                                                      <input class="@error('password') is-invalid @enderror chkPasswordCls" value="{{ old('password') }}" type="password"  name="password" id="password_org" placeholder="{{ __('messages.PASSWORD') }} *">
                                                      @if ($errors->has('password'))
