                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php if (@$search['cntrId'] != '') {
                                                                        echo @$search['cntrId'];
                                                                    } ?>" id="cntrId" name="cntrId" />
                                        <input class="form-control" id="country_id" name="country" type="text" value="<?php if (@$search['country'] != '') {
                                                                                                                            echo @$search['country'];
                                                                                                                        } ?>" placeholder="Country" />
                                ...
                                <div class="col-12 col-sm-6 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status">
                                            ...
                                            <!-- <option value="2" <?php // if(@$search['status'] == 2) echo 'selected'; 
                                                                    ?>>Deactivated</option> -->
                        ...
                        <div class="table-responsive">
                            <table class="table custom-table" id="candidateList">
                                ...
                                <tbody>
                                    ...
                                    <?php $i++; ?>
                                    <tr class="{{!empty($company['deleted_at']) ? 'deletedCompany' : ''}}">
                                        <td><?php echo $i; ?></td>
                                        <td>
                                            <a class="dropdown-item" href="{{!empty($company['deleted_at']) ? 'javascript:void(0)' : url('company/profile/'.$company['slug'])}}">{{$company['company_name']}} </a>
                                        </td>
                                        <td>{{$company['email']}}</td>
                                        <td><?php echo ($company['cnpj'] ? $company['cnpj'] : 'N/A'); ?></td>
                                        <td>{{$company['first_name'].' '.$company['last_name']}} </td>
                                        <td><?php echo count($company['job']); ?></td>
                                        <td><?php if ($company['country'] != null) {
                                                echo $company['country']['name'];
                                            } else {
                                                echo 'N/A';
                                            } ?></td>
                                        <td><?php if ($company['state'] != null) {
                                                echo $company['state']['name'];
                                            } else {
                                                echo 'N/A';
                                            } ?></td>
                                        <td>
                                            @php $approve = data_get($company, 'profile.approve_status'); @endphp
                                            @if($approve == 1)
                                            Approved
                                            @elseif($approve == 2)
                                            Rejected
                                        ...
                                        @if(!empty($company['deleted_at']) || $company['deleted_at'] != null)
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" id="bag" style="list-style-type: none;">
                                                    <li><a href="javascript:void(0);">
                                                            <p class="dropdown-item delete_item" data-toggle="modal" data-target="#company-{{$company['id']}}">Approve Delete</p>
                                                        </a></li>
                                                </ul>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" id="bag" style="list-style-type: none;">
                                                    ...
                                                    @if($company['profile']['approve_status'] != 1)
                                                    <li><a href="javascript:void(0);">
                                                            <p class="dropdown-item delete_item" data-toggle="modal" data-target="#company-{{$company['id']}}">Delete</p>
                                                        </a></li>
                                                    @endif
                                                </ul>
                                            </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr class="rpt-no-report rpt" style="display:none;">
                                <td colspan="4">
                                    <div class="" style="text-align: center;"> No report found.</div>
                                </td>
                            </tr>
