        ...
        <div class="row mb-2">
            ...
            <div class="col-12 col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"> @if(data_get($plan, 'id') != '') Edit Stripe Product @else Add Stripe Product @endif</li>
                </ol>
            </div>
        </div>
        <div class="row mb-2">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <form role="form" method="post" id="editAdvertise" action="{{ url('admin/product-list-edit') }}" enctype="multipart/form-data">
                    ...
                    <input name="plan_id" type="hidden" value="{{ data_get($plan, 'id') }}">
                    @else
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@if(data_get($plan, 'id') != '') Edit Stripe Product @else Add Stripe Product @endif</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="plan_name" id="plan_name" value="{{ data_get($plan, 'name') ?: data_get($plan, 'product.name') ?: data_get($plan, 'product.description') ?: '' }}" class="form-control" id="name" placeholder="Plan Name">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="desc" name="desc" value="{{ data_get($plan, 'statement_descriptor', '') }}" maxlength="22">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="plan_desc" name="plan_desc">{{ data_get($plan, 'product.description') ?: data_get($plan, 'product') ?: '' }}</textarea>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" id="general" name="general" value="{{ trim(data_get($plan, 'product_metadata.General', '')) }}">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" id="Free" name="free" value="{{ trim(data_get($plan, 'product_metadata.Free', '')) }}">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" id="below_description" name="below_description" value="{{ trim(data_get($plan, 'product_metadata.Below Description', '')) }}">
