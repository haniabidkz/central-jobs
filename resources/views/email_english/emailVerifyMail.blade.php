                                 ...
                                 <tbody>
                                    <tr>
                                       <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#444;font-size:14px;line-height:150%" valign="top">
                                          ...
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Thank you for placing the registration request.</p></br>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Your account has been created successfully but your email is not verified yet. Please <a href="{{url('verify-user-email/'.$userData['email_verify_token'])}}">click here</a> to verify your email id.</p>
