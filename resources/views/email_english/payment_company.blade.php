                                  ...
                                  <tbody>
                                     <tr>
                                        <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#444;font-size:14px;line-height:150%" valign="top">
                                           ...
                                           <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Your Payment was successful on MeuRH. Payment details are as following:</p></br>
 
                                           <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Payment ID: {{$transactionInfo->payment_id}}</p></br>
                                           <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Name: {{$user->first_name}} {{$user->last_name}}</p></br>
                                           ...
                                           <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Company Name: {{$user->company_name}}</p></br>
                                           <?php if($transactionInfo->created_at != '' || ($transactionInfo->created_at != NULL)){?>
                                           <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Transaction Date-time: {{date('Y-m-d H:i:s',strtotime($transactionInfo->created_at))}}</p></br>
                                           <?php }?>
                                           <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Price Paid (€): {{$transactionInfo->amount}}</p></br>
                                           <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Your Receipt : <a href="{{$transactionInfo->receipt_url}}" target="_blank">View Receipt</a></p></br>
