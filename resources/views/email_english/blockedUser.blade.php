                                 ...
                                 <tbody>
                                    <tr>
                                       <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#444;font-size:14px;line-height:150%" valign="top">
                                          ...
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">We are sorry to inform you that your account has been blocked by admin and the reason behind this is "{{$user['block_reason']}}".</p> </br>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">If you have any query please contact MeuRH at {{$admin}}.</p>
