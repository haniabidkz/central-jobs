                                 ...
                                 <tbody>
                                    <tr>
                                       <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#444;font-size:14px;line-height:150%" valign="top">
                                          ...
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Some new jobs vacancies has been posted based on "Alert Settings"</p> </br>
                                          ...
                                          <?php }?>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a"><a href="{{env('APP_URL')}}">View All Jobs</a></p> </br>
