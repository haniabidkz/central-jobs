                                 ...
                                 <tbody>
                                    <tr>
                                       <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#444;font-size:14px;line-height:150%" valign="top">
                                          ...
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Contact Information successfully received.</p></br>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Name: {{$userData['name']}} </p> </br>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Email: {{$userData['email']}}</p> </br>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Message Type : {{$userData['subject']}}</p> </br>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Message: {{$userData['description']}}</p> </br>
