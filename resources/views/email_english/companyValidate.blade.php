                                 ...
                                 <tbody>
                                    <tr>
                                       <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#444;font-size:14px;line-height:150%" valign="top">
                                          ...
                                          <p style="margin-top:30px;margin-bottom:30px;font-size:14px;line-height:1.7;color:#6a6a6a">This is to inform you that your registration request has been approved.</p></br>
                                             <p style="margin-top:30px;margin-bottom:30px;font-size:14px;line-height:1.7;color:#6a6a6a"><a href="{{env('APP_URL')}}">Visit the MeuRH Home Page</a></p>
                                          @elseif($user['profile']['approve_status']== 2)
                                          <p style="margin-top:30px;margin-bottom:30px;font-size:14px;line-height:1.7;color:#6a6a6a">Regret to inform you that your registration request has been rejected.</p>
                                          </br>
                                          @endif
                                          <p style="margin-top:30px;margin-bottom:30px;font-size:14px;line-height:1.7;color:#6a6a6a">If you have any query please contact MeuRH at {{$admin}}.</p> 

                                          <p style="margin-top:15px;margin-bottom:0px;font-size:14px;line-height:1.5;color:#555">Best Regards,<br>
                                          MeuRH team
                                          </p>
                                       </td>
                                    </tr>
