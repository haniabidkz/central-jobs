                                 ...
                                 <tbody>
                                    <tr>
                                       <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#444;font-size:14px;line-height:150%" valign="top">
                                          ...
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Thank you for contacting us!</p></br>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Your message has been received.</p></br>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">We will answer to you soon.</p></br>
                                       </br>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a"><a href="{{env('APP_URL')}}">Click here</a> to access the website Meu-RH.</p> </br>
                                          <p style="font-size:14px;line-height:1.5;color:#555">Kind Regards,<br>
                                          MeuRH team
                                          </p>
                                       </td>
                                    </tr>
