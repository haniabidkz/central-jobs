                                 ...
                                 <tbody>
                                    <tr>
                                       <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#444;font-size:14px;line-height:150%" valign="top">
                                          ...
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Name: {{$userData['name']}} </p> </br>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">E-mail: {{$userData['email']}}</p> </br>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Tipe de mensagem : {{$userData['subject']}}</p> </br>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Mensagem: {{$userData['description']}}</p> </br>
