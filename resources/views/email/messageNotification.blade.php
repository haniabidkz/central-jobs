                                 ...
                                 <tbody>
                                    <tr>
                                       <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#444;font-size:14px;line-height:150%" valign="top">
                                                ...
                                                <tbody>
                                                   <tr>
                                                      <td>
                                                         ...
                                                         Prezado (a) <?php echo $userData['to_first_name'];?>,
                                                         </h1>
                                                      </td>
                                          ...
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Informamos que {{$userData['from_first_name']}} enviou {{$userData['message']}}</p>
