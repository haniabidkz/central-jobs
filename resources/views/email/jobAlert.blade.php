                                 ...
                                 <tbody>
                                    <tr>
                                       <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#444;font-size:14px;line-height:150%" valign="top">
                                          ...
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Este e-mail é para informa você que {{$userData['details']['fromUser']['company_name']}} publicou um novo anúncio de emprego.</p> </br>
                                          ...
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Publicado em:{{date('Y-m-d',strtotime($val['start_date']))}}</p> </br>
                                          <?php }?>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a"><a href="{{env('APP_URL')}}">Ver anúncio</a></p> </br>
