                                 ...
                                 <tbody>
                                    <tr>
                                       <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#444;font-size:14px;line-height:150%" valign="top">
                                          ...
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Es tut uns leid, Ihnen mitteilen zu müssen, dass Ihr Konto von admin blockiert wurde und der Grund dafür ist "{{$user['block_reason']}}".</p> 
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Caso você tenha alguma dúvida, por favor entre em contato com o Meu-RH {{$admin}}.</p>
