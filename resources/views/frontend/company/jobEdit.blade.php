                                 ...
                                 <div class="login-form">
                                    ...
                                    <div class="col-12 col-sm-6 col-xl-4">
                                       ...
                                       <div class="form-group required">
                                          ...
                                          <input type="text" class="form-control" placeholder="{{ __('messages.TYPE') }} *" name="type" id="type" value="{{$details['type']}}" autocomplete="off">
                                       </div>
                                       <label class="error error-type" style="display:none;"></label>   
                                    </div> 
...
<script type="text/javascript">
  ...
  placeholder: '{{ __('messages.JOB_DESCRIPTION') }} *',
  modules: {
    toolbar: [
      [{ 'header': [1, 2, false] }],
...
quill.on('text-change', function() {
  ...
  descriptionInput.value = quill.root.innerHTML;  // Get and update the hidden input
});
