                  ...
                  <div class="row">   
                     ...
                     <div class="col-12 col-sm-6 col-xl-4">
                        <div class="form-group">
                           <select class="form-control" name="status" id="status">
                              ...
                              <option value="1" <?php if(@$search['status'] == 1 || empty($search['status'])){ echo 'selected';}?>>{{ __('messages.ONGOING') }}</option>
                     ...
                     <label class="error error-required-search" style="display:none;"></label>
                        <div class="form-group d-flex">
                           ...
                           <?php } ?><span class="search-refresh-text"> ({{ __('messages.SEARCH_REFRESH_TEXT') }}) </span>
                        </div>
                     </div>
                  </div>
                  </form>
