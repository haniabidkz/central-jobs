                           ...
                           <div class="col-12 col-sm-6 col-xl-4">
                              <div class="form-group required">
                                 <select class="form-control" name="country_id" id="country_id" disabled>
                                    ...
                                    ?>
                                          <option value="{{$val['id']}}" <?php if ($val['id'] == $selectedCountry) {
                                                                              echo 'selected';
                                                                           } ?>>{{$val['name']}}</option>
                                    <?php }
                                    } ?>
         ...
         <div class="form-group required"> Annual Salary:
            <div class="">
               ...
               <select name="annual_salary" class="form-control" required>
                  ...
                  <option value="Up To €35000">{{ __('messages.UP_TO_€35.000') }}</option>
                  <option value="35001 - €50000">{{ __('messages.€35.001_€50.000') }}</option>
                  <option value="50001 - €65000">{{ __('messages.€50.001_€65.000') }}</option>
                  <option value="65001 - €85000">{{ __('messages.€65.001_€85.000') }}</option>
                  <option value="Above €85000">{{ __('messages.ABOVE_€85.000') }}</option>
               </select>
            </div>
         </div>
      </div>
