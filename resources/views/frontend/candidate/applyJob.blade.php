                      ...
                      <div class="col-12"> 
                        <div class="section-myprofile">
                          ...
                          <div class="login-form" id="next-interview-qus"> 
                             <div class="row">
                             <div class="col-sm-12 details-panel-header">
                                   <h4 class="mb-4">{{__('messages.VIDEO_QUESTION')}}</h4>
                                   <div class="info-holder">
                                       <div class="row">
                                          <div class="mb-3 col-sm-12">
                                             <h4 class="text-left"> {{__('messages.VIDEO_QUESTION_SEC_1')}}  </h4>
                                          </div>
                                          <div class="mb-3 col-sm-12">
                                             <h4 class="text-left"> {{__('messages.VIDEO_QUESTION_SEC_2')}}  </h4>
                                          </div>
                                          <div class="col-sm-12 col-xl-12">
                                          
                                          <h5 class="total-title"> {{__('messages.VIDEO_QUESTION_SEC_3')}} </h5>
                                          <p><i class="mr-2 fa fa-paper-plane-o" aria-hidden="true"></i> {{__('messages.VIDEO_QUESTION_SEC_3_1')}} </p>
                                          <p><i class="mr-2 fa fa-paper-plane-o" aria-hidden="true"></i> {{__('messages.VIDEO_QUESTION_SEC_3_2')}} </p>
                                          <p><i class="mr-2 fa fa-paper-plane-o" aria-hidden="true"></i> {{__('messages.VIDEO_QUESTION_SEC_3_3')}}</p>
                                          <p><i class="mr-2 fa fa-paper-plane-o" aria-hidden="true"></i> {{__('messages.VIDEO_QUESTION_SEC_3_4')}}  </p>
                                          <p><i class="mr-2 fa fa-paper-plane-o" aria-hidden="true"></i> {{__('messages.VIDEO_QUESTION_SEC_3_5')}}  </p>
                                          <p><i class="mr-2 fa fa-paper-plane-o" aria-hidden="true"></i> {{__('messages.VIDEO_QUESTION_SEC_3_6')}}  </p>
                                          <p><i class="mr-2 fa fa-paper-plane-o" aria-hidden="true"></i> {{__('messages.VIDEO_QUESTION_SEC_3_7')}}  </p>

                                          <h5 class="mt-4 total-title"> {{__('messages.VIDEO_QUESTION_SEC_4')}}</h5>
                                          <p>  {{__('messages.VIDEO_QUESTION_SEC_4_1')}}</p>
                                          </div>
                                    ...
                                    <div class="interview-question-holder">
                                       ...
                                       <div class="mb-5 form-group">
                                          <div class="mb-4 d-flex"> 
                                             <label class="mb-0 page-title">{{__('messages.QUESTION')}} : <span>  {{__('messages.DO_YOU_WANT_TO_ACTIVE_QUESTION')}} </span> </label>
                                             ...
                                             <div class="switch-slider timerButtons">
                                               <label class="switch">
                                                  <input id="start_vid_interview_{{$key}}" type="checkbox" <?php if(!empty($attemptArr[$interviewQuestion['id'][$key]])){ echo 'checked disabled';} ?> class="start_vid_interview_{{$key}}">
                                                  <span class="slider round"></span>
                                               </label>
                                             </div>  
                                          ...
                                          <div class="show_hide_question_interview_{{$key}}" style="<?php  if(!empty($attemptArr[$interviewQuestion['id'][$key]])){ echo 'display:block';}else{ echo 'display:none';}?>">
                                          ...
                                          <input type="hidden" id="video_answer_{{$key+1}}" name="video_answer_{{$key+1}}" value=""/>
                                            </div>
