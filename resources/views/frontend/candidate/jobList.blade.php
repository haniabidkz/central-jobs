                  ...
                  <div class="section-myprofile">
                     <div class="login-form">
                        ...
                        <div class="row mb-4" id="checkPosition" <?php if (@$search['company'] == 1) { ?> style="display:block;" <?php } else { ?> style="display:none;" <?php } ?>>
                           <div class="col-12">
                              <h4 class="total-sub-title">{{ __('messages.POSITION_NAME') }}</h4>
                           </div>
                           <div class="col-12 d-flex input-search-holder ">
                              ...
                              <div class="input-search">
                                 <div class="form-group required">
                                    <select name="position_name[]" id="position_name" data-placeholder="{{ __('messages.KEYWORD') }}" id="itskills" class="form-control js-example-tags" multiple="multiple" style="display: none;">
                                       ...
                                       ?>
                                             <option value="{{$val}}" <?php if ((isset($search['position_name'])) && in_array($val, $search['position_name'], TRUE)) {
                                                                           echo 'selected';
                                                                        } ?>>{{$val}}</option>
                                       <?php }
                                       } ?>
                                    </select>
                                    {{-- <input type="text" class="form-control" name="position_name[]" value="{{$search['position'][0]}}" placeholder="Keyword"> --}}
                                 </div>
                              </div>
                              ...
                              <!-- <div class="input-search">
                                    ...
                                    ?>
                                    <option value="{{$value['id']}}" <?php if ($value['id'] == @$search['state']) {
                                                                        echo 'selected';
                                                                     } ?>>{{$value['name']}}</option>
                                    <?php }
                                       }
                              ...
                              <div class="input-search">
                                 <div class="form-group">
                                    <select name="cityy_comp" id="cityy_comp" class="form-control select-city-area">
                                       ...
                                       ?>
                                             {{$city->id}}
                                             <option value="{{$city->id}}" <?php if ($city->id == @$search['cityy_comp']) {
                                                                              echo 'selected';
                                                                           } ?>>{{$city->name}}</option>
                                       <?php  }
                                       } ?>
                              ...
                              <div class="input-search">
                                 <div class="form-group">
                                    <select name="annual_salary" class="form-control">
                                       <option value="">{{ __('messages.ANNUAL_SALARY') }} *</option>
                                       <option value="Up To €35000" {{ @$search['annual_salary'] == 'Up To €35000' ? 'selected' : '' }}>
                                          {{ __('messages.UP_TO_€35.000') }}
                                       </option>
                                       <option value="35001 - €50000" {{ @$search['annual_salary'] == '35001 - €50000' ? 'selected' : '' }}>
                                          {{ __('messages.€35.001_€50.000') }}
                                       </option>
                                       <option value="50001 - €65000" {{ @$search['annual_salary'] == '50001 - €65000' ? 'selected' : '' }}>
                                          {{ __('messages.€50.001_€65.000') }}
                                       </option>
                                       <option value="65001 - €85000" {{ @$search['annual_salary'] == '65001 - €85000' ? 'selected' : '' }}>
                                          {{ __('messages.€65.001_€85.000') }}
                                       </option>
                                       <option value="Above €85000" {{ @$search['annual_salary'] == 'Above €85000' ? 'selected' : '' }}>
                              ...
                              <div class="input-search">
                                 <div class="form-group">
                                    <select class="form-control" name="type" id="type">
                                       ...
                                       <option value="Hybrid" {{ @$search['type'] == 'Hybrid' ? 'selected' : '' }}>Hybrid</option>
                                       <option value="Onsite" {{ @$search['type'] == 'Onsite' ? 'selected' : '' }}>Onsite</option>
                                       <option value="Remote" {{ @$search['type'] == 'Remote' ? 'selected' : '' }}>Remote</option>
                                    </select>
                                 </div>
                              </div>
                              <div class="input-search">
                        ...
                        <div class="row mb-4" id="checkCompany" <?php if (@$search['company'] == 2) { ?> style="display:block;" <?php } else { ?> style="display:none;" <?php } ?>>
                           <div class="col-12">
                              <h4 class="total-sub-title">{{ __('messages.COMPANY_NAME') }}</h4>
                           </div>
                           <div class="col-12 d-flex input-search-holder ">
                              <div class="input-search">
                                 <div class="form-group">
                              ...
                              <!-- <div class="input-search">
                                    ...
                                    <?php if ($states1) {
                                       foreach ($states1 as $key => $value) {
                                          if ($value['name'] == 'Austria') {
                                    ?>
                                    <option value="{{$value['id']}}" <?php if ($value['id'] == @$search['state_comp']) {
                                                                        echo 'selected';
                                                                     } ?>>{{$value['name']}}</option>
                                    <?php }
                                       }
