      ...
      <div class="main-container">
               ...
               <div class="container">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="nav navbar-nav mr-auto">
                        ...
                        @endif
                        <li class="nav-item job-item dropdown dashboard-nav-item <?php if ($action == 'jobList' || $action == 'trackJob' || $action == 'postJob' || $action == 'editJob' || $action == 'viewJobPost' || $action == 'appliedCandidates' || $action == 'applyJob') {
                                                                                    echo 'active';
                                                                                 } ?>">
                        ...
                        <li class="nav-item all-nav <?php if ($action == 'aboutUs') {
                                                         echo 'active';
                                                      } ?>">
                           <a class="nav-link" href="{{url('about-us')}}">{{ __('messages.ABOUT_US') }}</a>
                        </li>
                        {{-- <li class="nav-item all-nav <?php if ($action == 'service') {
                                                            echo 'active';
                                                         } ?>">
                              <a class="nav-link" href="{{url('service')}}">{{ __('messages.SERVICES') }} </a> --}}
                        </li>
                        <li class="nav-item all-nav <?php if ($action == 'index' && $controller == 'TrainingController') {
                                                         echo 'active';
                                                      } ?>">
                           <a class="nav-link" href="{{url('training-category-list')}}">{{ __('messages.TRAINING') }}</a>
                        </li>
                        <li class="nav-item all-nav <?php if ($action == 'tips') {
                                                         echo 'active';
                                                      } ?>">
                           <a class="nav-link" href="{{url('tips')}}">{{ __('messages.TIPS') }}</a>
                        </li>
                                             ...
                                             <div class="media-body">
                                                <?php if ($value['type'] == 'message') { ?>
                                                   <?php if ((auth()->user()) && (auth()->user()->user_type == 2)) { ?>
                                                      ...
                                                      <?php } ?>
                                                      <h3 class="noti-name-cls"><?php if ($value['user']['user_type'] == 2) {
                                                                                    echo $value['user']['first_name'];
                                                                                 } else {
                                                                                    echo $value['user']['company_name'];
                                                                                 } ?> <span><?php echo time_elapsed_string($value['created_at']); ?></span></h3>
                                                      <p><?php echo substr($value['message']['message'], 0, 27);
                                                         if (strlen($value['message']['message']) > 27) {
                                                            echo '...';
                                                         } ?></p>
                                                      </a>
                                                   <?php } else if ($value['type'] == 'connection_request') { ?>
                                                      <?php if ((auth()->user()) && (auth()->user()->user_type == 2)) { ?>
                                                         ...
                                                         <p><?php if ($value['user']['user_type'] == 2) {
                                                               echo $value['user']['first_name'] . ' ' . __('messages.REQUESTED_TO_CONNECT');
                                                            } else {
                                                               echo $value['user']['company_name'] . ' ' . __('messages.REQUESTED_TO_CONNECT');
                                                            }; ?></p>
                                                         </a>
                                                      <?php } else if ($value['type'] == 'connection_accepted') { ?>
                                                         <?php if ((auth()->user()) && (auth()->user()->user_type == 2)) { ?>
                                                            ...
                                                            <p><?php if ($value['user']['user_type'] == 2) {
                                                                  echo $value['user']['first_name'] . ' ' . __('messages.HAS_ACCEPTED_YOUR_CONNECTION_REQUEST');
                                                               } else {
                                                                  echo $value['user']['company_name'] . ' ' . __('messages.HAS_ACCEPTED_YOUR_CONNECTION_REQUEST');
                                                               } ?></p>
                                                            </a>
                                                         <?php } else if ($value['type'] == 'connection_rejected') { ?>
                                                            <?php if ((auth()->user()) && (auth()->user()->user_type == 2)) { ?>
                                                               ...
                                                               <p><?php if ($value['user']['user_type'] == 2) {
                                                                     echo $value['user']['first_name'] . ' ' . __('messages.HAS_REJECTED_YOUR_CONNECTION_REQUEST');
                                                                  } else {
                                                                     echo $value['user']['company_name'] . ' ' . __('messages.HAS_REJECTED_YOUR_CONNECTION_REQUEST');
                                                                  } ?></p>
                                                               </a>
                                                            ...
                                                            <?php } else if ($value['type'] == 'follow') { ?>
                                                               <a href="{{url('/candidate/view-followers')}}/{{encrypt($value['id'])}}" title="">
                                                                  ...
                                                                  <p><?php if ($value['user']['user_type'] == 2) {
                                                                        echo $value['user']['first_name'] . ' ' . __('messages.IS_FOLLOWING_YOU');
                                                                     } else {
                                                                        echo $value['user']['company_name'] . ' ' . __('messages.IS_FOLLOWING_YOU');
                                                                     } ?></p>
                                                               </a>
                     ...
                     <div class="dropdown language-list">
                        <a class="dropdown-toggle" href="" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                           ...
                           <?php if (Cookie::get('locale') == 'en') {
                              echo 'En';
                           } else if (Cookie::get('locale') == 'fr') {
                              echo 'Fr';
                           } else if (Cookie::get('locale') == 'de' || Cookie::get('locale') == '') {
                              echo 'Ge';
                           } else if (Cookie::get('locale') == 'pt') {
                              echo 'Pt';
                           } ?>
                        </a>
         ...
         <?php if (Session::has('success-msg')) {
            ...
            <script type="text/javascript">
               ...
               setTimeout(function() {
                  msgBoxTempFlush.removeClass('success-block')
               }, 8000);
            </script>
         <?php } ?>
         <?php
                  ...
                  $.ajax({
                     ...
                     success: function(response) {
                        if (response.success == 0) {
                           ...
                           setTimeout(function() {
                              msgBox.removeClass('error-block')
                           }, 8000);
                           location.reload();
                        }
