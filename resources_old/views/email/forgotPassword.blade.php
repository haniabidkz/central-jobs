                                                   ...
                                                   <tr>
                                                      <td>
                                                         <h1 style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif;color:#444; display:block; font-size:15px; font-weight:600;line-height:1.5; margin:0">
                                                            Sehr geehrte {{$user}},
                                                            <span style="display:block;font-size:13px;font-weight:normal;color:#999"> Hier ist Ihre Passwort-Reset-Anleitung.</span>
                                                         </h1>
                                                      </td>
                                                   </tr>
                                                </tbody>
                                             ...
                                             <tbody>
                                                <tr>
                                                   <td style="border-radius:3px;" bgcolor="#ffc00" align="center">
                                                      <a href="{{url('admin/reset-password',$RememberToken)}}" style="padding: 0.8rem 1.2rem; text-decoration: none; display: inline-block; font-size: 14px; border-radius: 3px; color: #0b0001; border:none; background: #ffc000; ">Passwort zurücksetzen</a>    
                                                   </td>
                                                </tr>
                                             </tbody>
                                          </table>
                                          {{-- <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Caso você não tenha feito essa solicitação, por favor entre em contato com a nossa equipe (no rodapé da Home Page temos o formulário de contato).</p> --}}
