                     ...
                     <tbody>
                        <tr>
                           <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#999;font-size:13px;line-height:1.6; padding:20px 0" align="center">
                               <a href="{{env('APP_URL')}}" target="_blank"><img src="{{ asset('frontend/images/logo-color2.png') }}" alt="logo" style="max-width: 180px"></a>
                           </td>
                        </tr>
                     </tbody>
                  </table>
                                 ...
                                 <tbody>
                                    <tr>
                                       <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#444;font-size:14px;line-height:150%" valign="top">
                                          ...
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a"><a href="{{url('verify-user-email/'.$userData['email_verify_token'])}}">Bitte klicken Sie hier</a> um Ihre E-Mail-ID zu verifizieren.</p>
                                          {{-- <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Obrigado!</p> --}}
