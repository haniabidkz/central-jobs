                                 ...
                                 <tbody>
                                    <tr>
                                       <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#444;font-size:14px;line-height:150%" valign="top">
                                                ...
                                                <tbody>
                                                   <tr>
                                                      <td>
                                                         ...
                                                         Prezado (a) {{$userData['details']['toUser']['first_name']}},
                                                         </h1>
                                                      </td>
                                          ...
                                          <!-- <p style="margin-top:30px;margin-bottom:30px;font-size:14px;line-height:1.7;color:#6a6a6a">This is to inform you that, {{$userData['details']['fromUser']['company_name']}} has posted a new job.</p> </br> -->
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Baseado na sua seleção de "alerta" para anúncios de empregos, temos abaixo alguns anúncios interessantes para você.</p> </br>
                                          <?php foreach($userData['details']['job_details'] as $key=>$val){?>
                                          ...
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Publicados em:{{date('Y-m-d',strtotime($val['start_date']))}}</p> </br>
                                          <?php }?>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a"><a href="{{env('APP_URL')}}">Ver todos os anúncios de emprego</a></p> </br>
