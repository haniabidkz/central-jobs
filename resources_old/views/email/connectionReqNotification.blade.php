                                 ...
                                 <tbody>
                                    <tr>
                                       <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#444;font-size:14px;line-height:150%" valign="top">
                                                ...
                                                <tbody>
                                                   <tr>
                                                      <td>
                                                         ...
                                                         Prezado (a) <?php echo $userData['first_name'];?>,
                                                         </h1>
                                                      </td>
                                                      <!-- <td width="58" align="right">
                                                         <a href=""><img alt="profile img" src="{{$userData['imgPath']}}" style="height:auto;line-height:100%;outline:none;text-decoration:none;display:inline;width:48px;border-radius:50%;border:0"  width="48" height="48"> </a>
                                                      </td> -->
                                                   </tr>
                                                </tbody>
                                             </table>
                                          ...
                                          <?php 
                                          if($userData['type'] == 'connection_request'){
                                             $msg = 'enviou a você uma solicitação de conexão e nota fornecida como "'.$userData['message'].'".';
                                          }else if($userData['type'] == 'connection_accepted'){
                                             $msg = 'aceitou sua solicitação de conexão.';
                                          }else if($userData['type'] == 'connection_rejected'){
                                             $msg = 'rejeitou seu pedido de conexão.';
                                          }
                                          ?>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Informamos que, {{$userData['from_first_name']}} {{$userData['from_last_name']}} {{$msg}}</p>
                                          <?php if($userData['type'] == 'connection_request'){ ?>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">O seu consentimento é necessário.</p>
                                          <?php }?>
                                          <p style="font-size:14px;line-height:1.5;color:#555">Atenciosamente,<br>
                                          Equipe Meu RH
                                          </p>
                                       </td>
                                    </tr>
