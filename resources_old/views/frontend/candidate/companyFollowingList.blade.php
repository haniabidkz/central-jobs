...
<div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 mb-3 mb-md-4 text-center">
        <div class="profile-whitebox">
            ...
            <h3 class="h3-profile">
            <a href="{{url('company/profile/'.$value['followingUser']['slug'])}}">
             {{$value['followingUser']['company_name']}}
            </a>
            </h3>
            <h6><a href="">{{$value['followingUser']['profile']['business_name']}}</a></h6>
            </div>
        </div>
    </div>
<?php } } if($count == 0){?>
