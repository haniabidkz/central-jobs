                    ...
                    <div class="row">
                      <div class="col-12"> 
                        <div class="section-myprofile">
                          ...
                          <input type="hidden" class="form-control" name="city" id="city" value="{{$jobDetails['city']}}"/>
                          <div class="login-form d-none" id="apply-job-company"> 
                          ...
                          <div class="login-form d-block" id="next-specific-qus"> 
                             <div class="row">
                          ...
                          <?php if(empty($specificQuestion['question'])){ $cls = 'd-block';} else{ $cls ='';}?>
                          <div class="login-form {{$cls}}" id="next-interview-qus"> 
                             <div class="row">
                                <div class="col-sm-12 details-panel-header">
                                   ...
                                   <h5 class="form-sub-heading"><i>"{{__('messages.TO_ANSWER_AN_INTERVIEW_QUESTION_YOU_NEED_TO_ACTIVATE_THE_QUESTION')}}" </i>
                                   <!-- <a class="ml-2" data-toggle="modal" data-target="#tips-interview"><i class="fa fa-question-circle" aria-hidden="true"></i></a>  -->
                                    </h5>
                             ...
                             <div class="row  mt-4">
                                ...
                                <?php if(count($specificQuestion['question']) > 0){?>
                                  <button class="btn site-btn-color enable-disable-cls-prev" id="prevbtn2" type="button">{{__('messages.PREV')}}</button>
                                  <?php }?>
