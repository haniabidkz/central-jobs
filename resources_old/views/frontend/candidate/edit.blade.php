                  ...
                  <div class="col-12 col-lg-4 col-xl-3">
                        <div class="profile-side-panel">
                           <div class="details-panel-header mb-4">
                             ...
                             <h3 class="h3-profile user-dynamic-name-func"><?php echo ($profileData['first_name']?$profileData['first_name']:'') .' '. ($profileData['last_name']?$profileData['last_name']:'') ;?></h3>
                             <h5 class="text-company user-profession-finc"><?php echo ($profileData['profile']['profile_headline']?$profileData['profile']['profile_headline']:'');?></h5>
                             <h6 class="color-lightgray address-data-func"><?php echo ($profileData['state']['name']?$profileData['state']['name']:'');?></h6>
                           </div>
                     ...
                     <div class="edit-profile-holder">
                        ...
                        <!-- <section class="section-myprofile" id="section5">
                           <div class="login-form">
                              <div class="row">
                                 <div class="col-12 details-panel-header">
                                    <h4>{{__('messages.UPLOAD_CV')}} </h4>
                                    <h6>{{__('messages.PROVIDE_THE_BASIC_INFORMATION_ABOUT_YOURSELF')}}</h6>
                                    <div class="edit-info-holder">
                                       <h5 class="form-sub-heading cv-update-section-info"> {{__('messages.UPDATE_NOW')}}</h5>
                                       <button class="btn site-btn-color editbtn open-cv-popup" data-toggle="modal" data-target="#cv-update"><img src="<?php echo url('/');?>/frontend/images/pencil-edit-button.svg" alt="Edit-icon"></button>
                                    </div> 
                                 </div>
                                 <div class="col-12 col-sm-12 col-md-6">
                                    
                                    <div class="cv-holder  @if(!empty($profileDataOld['uploadedCV'])) cv-holder-upload  @endif   cv-holder-page-section">
                                       <a href="javascript:void(0)" class="crossprofile remove-cv-file-func"><i class="la la-times"></i></a>
                                       <a href="{{asset($profileDataOld['uploadedCV']['location'])}}"  class="downloadprofile" download><i class="la la-download"></i></a>
                                       <div class="uploadprofile">
                                        
                                          <span><i class="la la-upload uploadprofile-now"></i></span>
                                       </div>
                                       @if(!empty($profileDataOld['uploadedCV']))
                                       <a class="uploadprofile-new" href="{{asset($profileDataOld['uploadedCV']['location'])}}" download>
                                          <?php
                                              // $filename = explode('.',$profileDataOld['uploadedCV']['name']);  
                                               //$fileType = $filename[(count($filename)-1)];
                                          ?>
                                          <?php //if($fileType == 'pdf'){ ?>
                                          <img src="<?php //echo url('/');?>/frontend/images/pdf-img.png" alt="{{$profileDataOld['uploadedCV']['name']}}" class="cv">
                                         <?php //}else{ ?>
                                             <img src="<?php// echo url('/');?>/frontend/images/doc-img.png" alt="{{$profileDataOld['uploadedCV']['name']}}" class="cv">
                                         <?php //} ?>
                                     ...
                                     @if(!empty($profileDataOld['uploadedCV']))
                                    <div class="media file-name-image Cv-file-name-container">
                                       <span class="mr-1"> <i class="la la-file-alt"></i> 
                                          
                                          <i class="la la-file-pdf d-none"></i>
                                       </span>
                                       <div class="media-body"><p class="cv-file-name-image">{{$profileDataOld['uploadedCV']['org_name']}}</p></div>
                                    </div>
                                    @endif
                                 </div>
                                  ...
                                  <div style="display: {{ $uploadedIntroStatus }}!important" class="intro-new-video intro-video intro-video-div-func">
                                       <a href="javascript:void(0)" class="crossprofile"><i class="la la-times remove-intri-video-func"></i></a>
                                        <video   controls class="video-js vjs-default-skin" >
                                              <source src="{{asset($profileDataOld['introVideo']['location'])}}" type="video/mp4">                                                                                    
                                        </video>  
                                    </div>  
                              ...
                              <div class="profile-bg ">
                                @if($imageLibrary)
                                    @foreach($imageLibrary as $imgLibRow)
                                     <div data-id="{{$imgLibRow['id']}}" class="profile-banner-holder func-profile-banner-holder <?php if($profileData['banner_image']['org_name'] == $imgLibRow['org_name']){ echo "selected-banner";}?>">
                        ...
                        <div class="row">
                           ...
                           <div class="col-12 col-sm-6 col-xl-6">
                              <div class="form-group required">
                                 <input value="{{$profileData['first_name']}}" name="first_name" id="first_name" type="text" class="form-control" placeholder="{{__('messages.NAME')}} *">
                              </div>
                           </div>
                           <div class="col-12 col-sm-6 col-xl-6">
                              <div class="form-group required">
                           ...
                           <div class="col-12 col-sm-6 col-xl-6">
                              <div class="form-group required">
                                 <input readonly="" value="{{ $profileData['email'] }}" name="email" id="email" type="email" class="form-control" placeholder="{{__('messages.EMAIL')}} *">
                              </div>
                           </div>
                           <div class="col-12 col-sm-6 col-xl-6">
                              <div class="form-group required">
