                           ...
                           <div class="post-block">
                              <div class="job-list-holder company-list-holder px-0 whitebg mb-2">
                                 <div class="media"> 
                                    ...
                                    <?php }else if(($postData['isApplied'] != null) && ($postData['isApplied']['applied_status'] == 0 || $job['isApplied']['applied_status'] == 1)){?>
                           ...
                           <div class="job-list-holder whitebg">  
                              <div class="row">
                                 ...
                                 <div class="col-12">
                                    ...
                                    <?php $serial = 0; if($postData['questions']){ 
                                       foreach($postData['questions'] as $key=>$val){
                                 ...
                                 <div class="col-12 mb-3">
                                    ...
                                    <?php $serial1 = 0; if($postData['questions']){ 
                                       foreach($postData['questions'] as $key=>$val){
