                     ...
                     <div class="row">
                        <div class="col-md-12 col-12">
                           <div class="success-message-holder text-center admin-block-section">
                              ...
                              <h2 class="title mb-4">{{ __('messages.YOUR_ACCOUNT_HAS_NOT_VALIDATE_YET_BY_THE_ADMIN') }} </h2>
                              <div class="my-3">   
                              ...
                              <div class="row mt-5">
                                 <div class="col-12 col-lg-12 text-left">
                                    <h4>{{ __('messages.WHY_THIS_HAPPENS') }} </h4>
                                    <p>{{ __('messages.IN_ORDER_TO_ENSURE_THE_SECURITY') }}</p>
                                 </div>
                                 <div class="col-12 col-lg-12 text-left">
                                    <h4>{{ __('messages.WHAT_SHOULD_I_DO_NOW') }} </h4>
                                    <p>{{ __('messages.SOON_YOU_WILL_RECIVE_AN_EMAIL') }}</p>
                                    <p>{{ __('messages.INCASE_YOU_DONOT_RECEIVE_IT_IN_UPTO_24H_PLEASE_CONTACTUS') }}</p>
                                 </div>
                              </div>
                              <div class="row mt-3">
                                 <div class="col-12 col-lg-12 text-left">
