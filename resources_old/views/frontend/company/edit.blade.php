                  ...
                  <div class="login-form">
                     <div class="row">
                        <div class="col-sm-12 details-panel-header">
                           <h4 class="text-left">{{ __('messages.PROFESSIONAL_INFO') }}</h4>
                           <h6>{{ __('messages.PROVIDE_THE_BASIC_INFORMATION_ABOUT_YOURSELF') }}</h6>
                        </div>
                        <div class="col-12">
                           <div class="form-group required">
                              <input type="text" class="form-control uniqueChk" placeholder="{{ __('messages.COMPANY_NAME') }}  *" value="{{$profileData['company_name']}}" name="company_name" id="company_name" readonly="">
                              <label id="" class="error errorCls" for="" style="display:none;"></label>
                           </div>
                        </div>
                        <div class="col-12 col-sm-6 col-xl-6">
                           <div class="form-group required">
                              <input type="text" class="form-control" placeholder="{{ __('messages.COMPANY_BUSINESS') }} *" value="{{$profileData['profile']['business_name']}}" name="business_name" id="business_name" <?php if($profileData['profile']['business_name'] != ''){?>readonly="" <?php }?>>
                           </div>
                        </div>
                        <div class="col-12 col-sm-6 col-xl-6">
                           <div class="form-group required">
                              <input type="text" class="form-control" placeholder="{{ __('messages.CONTACT_NAME') }} *" value="{{base64_decode($profileData['first_name'])}}" name="first_name" id="first_name">
                           </div>
                        </div>
                        <div class="col-12 col-sm-6 col-xl-6">
                           <div class="form-group required">
                              <input type="text" class="form-control" placeholder="{{ __('messages.TELEPHONE_NO') }}" value="{{base64_decode($profileData['telephone'])}}" name="telephone" id="telephone">
                           </div>
                        </div>
                        <div class="col-12 col-sm-6 col-xl-6">
                           <div class="form-group required">
                              <input type="email" class="form-control" placeholder="{{ __('messages.COMPANY_EMAIL') }} *" value="{{base64_decode($profileData['email'])}}" name="email" id="email" readonly="">
                           </div>
                        </div>
                        <div class="col-12 col-sm-6 col-xl-6">
                           <div class="form-group required">
                              <input type="text" class="form-control" placeholder="{{ __('messages.CNPJ') }} *" value="{{$profileData['cnpj']}}" name="cnpj" id="cnpj" readonly="">
                           </div>
                        </div>
                        <div class="col-sm-6 col-xl-6">
                           <div class="form-group required">
                              ...
                              <select class="form-control" name="country_id" id="country_id">
                                 <option value="" selected data-default>{{ __('messages.COUNTRY') }} *</option>
                        ...
                        <div class="col-sm-6 col-xl-6">
                           <div class="form-group required">
                              <select name="state_id" data-placeholder="State" id="state_id" class="form-control "  style="display: block;">
                                 <option value="" selected data-default>{{ __('messages.STATE') }} *</option>
                        ...
                        <div class="col-12 col-xl-12">
                           <div class="form-group required">
                              <input type="text" class="form-control" placeholder="{{ __('messages.ADDRESS_LINE1') }} *" value="{{$profileData['address1']}}" name="address1" id="address1">
                           </div>
                        </div>
                        <div class="col-12 col-xl-12">
                           <div class="form-group required">
                              <input type="text" class="form-control" placeholder="{{ __('messages.ADDRESS_LINE2') }}" value="{{$profileData['address2']}}" name="address2" id="address2">
                           </div>
                        </div>
                        <div class="col-12">
                           <div class="form-group required">
                              <input type="text" class="form-control" placeholder="{{ __('messages.ZIP_CODE') }} *" value="{{$profileData['postal']}}" name="postal" id="postal">
                           </div>
                        </div>
                        <div class="col-12">
