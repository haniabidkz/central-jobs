        ...
        <div class="row mb-2">
            <div class="col-12">
                <?php if($details['profile']['approve_status'] == 0 || $details['profile']['approve_status'] == 2){?>
                    <button type="button" class="btn btn-info ml-3 opnMdlCls"  data-id="{{$details['id']}}">Approve</button>
                <?php }?>
                <?php if($details['status'] == 1){?>
                    <button type="button" class="btn btn-danger opnBlkModal" data-id="{{$details['id']}}">Block</button>
                <?php }else{?>
                    <button type="button" class="btn btn-info ml-3 status" data-id="{{$details['id']}}" data-val="1">Unblock</button>
                <?php }?>
