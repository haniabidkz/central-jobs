                                 ...
                                 <tbody>
                                    <tr>
                                       <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#444;font-size:14px;line-height:150%" valign="top">
                                          ...
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">To retrieve your misplaced password please click on the link below.</p> </br></br>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">NOTE : Password reset link is valid for 60 minutes.</p>
                                             ...
                                             <tbody>
                                                <tr>
                                                   <td style="border-radius:3px;" bgcolor="#ffc00" align="center">
                                                      <a href="{{url('password/reset/'.$RememberToken.'?email='.$user['email'])}}" style="padding: 0.8rem 1.2rem; text-decoration: none; display: inline-block; font-size: 14px; border-radius: 3px; color: #0b0001; border:none; background: #ffc000; ">Reset password</a>    
                                                   </td>
                                                </tr>
                                             </tbody>
                                          </table>
