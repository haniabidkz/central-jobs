...
<input type="hidden" name="user_type" value="<?php echo e($user_type); ?>" id="user_type"/>
 <link href="https://unpkg.com/cropperjs/dist/cropper.css" rel="stylesheet"/>
 <script src="<?php echo e(asset('frontend/js/sweetalert.min.js')); ?>"></script>
 <link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/smoothness/jquery-ui.css">
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
<script src="<?php echo e(asset('frontend/js/viewFollower.js')); ?>"></script>
      <!-- main -->
     <main>
                  ...
                  <div class="col-12 col-lg-4 col-xl-3">
                     <div class="profile-side-panel">
                        <div class="details-panel-header mb-4" id="leftMenu">
                           <div class="profile-img-holder">
                              <div class="profile-bg-img">
                                 ...
                                 <img id="banner-image-src" src="<?php echo e(asset($profileData['bannerImage']['location'])); ?>" alt="user-profile-bg">
                                 <?php }else{?>
                                    <img id="banner-image-src" src="<?php echo e(asset('frontend/images/user-pro-bg-img.jpg')); ?>" alt="user-profile-bg">
                                 <?php }?>
                                

                                <!--  <div class="msk d-flex justify-content-center" data-toggle="modal" data-target="#change-image-banner">
                                    <img class="cam-open cam-banner-open" src="<?php echo e(asset('frontend/images/ic-camera-icon.svg')); ?>" alt="camara">
                                 </div> -->
                              ...
                              <div class="profile-img">
                                 ...
                                 <img id="profile-image-src" src="<?php echo e(asset($profileData['profileImage']['location'])); ?>" alt="user-profile">
                                  <?php }else{?>
                                    <img id="profile-image-src" src="<?php echo e(asset('frontend/images/user-pro-img-demo.png')); ?>" alt="user-profile">
                                  <?php }?>
                        ...
                        <!--<div class="user_pro_status">
                           <h3><span><?php echo e(__('messages.FOLLOWERS')); ?> <b><?php echo e($allFollowers); ?></b></span></h3>
                        </div>-->
                        <div class="followers-holder">
                           <!--<div class="followers-title">
                              <h3><?php echo e(__('messages.PEOPLE_VIEWED_PROFILE')); ?></h3>
                        ...
                        foreach($allFollowersList as $key=>$val){ 
                           if($val['user']['user_type'] == 2){ 
                              ...
                              <?php if($val['user']['profileImage'] != null){?>
                                 <img src="<?php echo e(asset($val['user']['profileImage']['location'])); ?>" alt="">
                              <?php }else{ ?>
                                 <img src="<?php echo e(asset('frontend/images/user-pro-img-demo.png')); ?>" alt="">
                              <?php }?>
                                 <div class="media-body">
                                    <h4><a href="<?php echo e(url($type.'/profile/'.$val['user']['slug'])); ?>"> <?php //echo $val['user']['first_name'].' '.$val['user']['last_name']; ?></a></h4>
                                 ...
                                 <!-- <div class="dropdown msg-dropdown">
                                    ...
                                    <a href="javascript:void(0);" class="btn site-btn-color dropdown-toggle block_user" type="button" data-id="<?php echo e($val['user']['id']); ?>" <?php if($val['user']['isUserBlockedByLogedInUser'] != null){?> data-block="0" <?php }else{?> data-block="1" <?php }?> id="block_user_<?php echo e($val['user']['id']); ?>">
                              ...
                              <?php } }?>
                              <!--<div class="view-more">
                                 <a href="<?php echo e(url('company/view-followers')); ?>" title="" class="btn site-btn"><?php echo e(__('messages.VIEW_FOLLOWERS')); ?></a>
                              </div>-->
                           <!-- </div> -->
                           ...
                           <div class="login-form">
                              <div class="row">
                                 <div class="col-12 details-panel-header">
                                    <h4><?php echo e(__('messages.PROFILE_INFORMATION')); ?></h4>
                                    <h6><?php echo e(__('messages.PROVIDE_THE_BASIC_INFORMATION_ABOUT_YOURSELF')); ?></h6>
                                    <div class="edit-info-holder">
                                       <h5 class="form-sub-heading"> <?php echo e(__('messages.PROFESSIONAL_INFO')); ?> </h5>
                                       <button class="btn site-btn-color editbtn" data-toggle="modal" data-target="#professional-info" ><img src="<?php echo e(asset('frontend/images/pencil-edit-button.svg')); ?>" alt="edit"></button>
                                    </div>
                                 </div>
                                 <div class="col-12 col-sm-12 col-md-6">
                                    <div class="form-view">
                                       <label class="label-tag"><?php echo e(__('messages.COMPANY_NAME')); ?> :</label> 
                                       <span class="company_name_func"> 
                                       <?php echo ($profileData['company_name']?$profileData['company_name']:'');?>
                                    </span>
                                    </div>
                                 ...
                                 <div class="col-12 col-sm-12 col-md-6">
                                    <div class="form-view">
                                       <label class="label-tag"><?php echo e(__('messages.COMPANY_BUSINESS')); ?> :</label> 
                                       <span class="business_name_func"> 
                                 ...
                                 <div class="col-12 col-sm-12 col-md-6">
                                    <div class="form-view">
                                       <label class="label-tag"><?php echo e(__('messages.TELEPHONE_NO')); ?> :</label> 
                                 ...
                                 <div class="col-12 col-sm-12 col-md-6">
                                    <div class="form-view">
                                       <label class="label-tag"><?php echo e(__('messages.CONTACT_NAME')); ?> :</label> 
                                 ...
                                 <div class="col-12 col-sm-12 col-md-6">
                                    <div class="form-view">
                                       <label class="label-tag"><?php echo e(__('messages.COMPANY_EMAIL')); ?> :</label> 
                                 ...
                                 <div class="col-12 col-sm-12 col-md-6">
                                    <div class="form-view">
                                       <label class="label-tag"><?php echo e(__('messages.CNPJ')); ?> :</label> 
                                 ...
                                 <div class="col-12 col-sm-12 col-md-6">
                                    <div class="form-view">
                                       <label class="label-tag"><?php echo e(__('messages.COUNTRY')); ?> :</label> 
                                       <span class="country_id_func">
                                       <?php echo (isset($profileData['country']['name'])?$profileData['country']['name']:'');?>
                                    </span>
                                    </div>
                                 ...
                                 <div class="col-12 col-sm-12 col-md-6">
                                    <div class="form-view">
                                       <label class="label-tag"><?php echo e(__('messages.STATE')); ?> :</label> 
                                 ...
                                 <div class="col-12 col-sm-12 col-md-6">
                                    <div class="form-view">
                                       <label class="label-tag"><?php echo e(__('messages.CITY')); ?> :</label> 
                                 ...
                                 <div class="col-12 col-sm-12 col-md-6">
                                    <div class="form-view">
                                       <label class="label-tag"><?php echo e(__('messages.ADDRESS_LINE1')); ?> :</label> 
                                 ...
                                 <div class="col-12 col-sm-12 col-md-6">
                                    <div class="form-view">
                                       <label class="label-tag"><?php echo e(__('messages.ADDRESS_LINE2')); ?> :</label> 
                                 ...
                                 <div class="col-12 col-sm-12 col-md-6">
                                    <div class="form-view">
                                       <label class="label-tag"><?php echo e(__('messages.ZIP_CODE')); ?> :</label> 
      ...
      <script src="<?php echo e(asset('frontend/js/profile.users.js')); ?>"></script>
               ...
               <div class="modal-body">
                  <div class="upload-photo d-flex justify-content-between">
                     <div class="upload-photo-inner" data-toggle="modal" data-target="#change-image-before">
                        ...
                        <h4><?php echo e(__('messages.UPLOAD_PHOTO')); ?></h4>
                     </div>
                     <div class="upload-photo-inner">
                        ...
                        <h4 id="change-image-remove"><?php echo e(__('messages.REMOVE_EXISTING_IMAGE')); ?> </h4>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <div class="modal custom-modal change-image profile-img-upload" id="change-image-before">
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-body">
                 <h5 class="text-center mt-0 heading-profile-img"> <?php echo e(__('messages.PROFILE_IMAGE_UPLOAD')); ?> </h5>
                  <div class="drag-div">
                     ...
                     <div class="drag-div-inner">
                        <h6 id="upload_image_now" class="upload-profile-img-func"><?php echo e(__('messages.UPDATE_IMAGE')); ?></h6>
                     </div>
                  </div>
               </div>
            </div>
                  ...
                  <!-- <div class="upload-photo d-flex justify-content-between">
                     ...
                     <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                           <!-- <h5 class="mt-0 heading-profile-img"><?php echo e(__('messages.IMAGE_UPLOAD')); ?> </h5> -->
                           <div class="drag-div">
                              <span class="after-span top-left"></span> <span class="after-span top-right"></span>
                              <span class="after-span bottom-left"></span> <span class="after-span bottom-right"></span>
                             <!--  <form action="/file-upload" class="dropzone" id="myBannerDropzone">
                              ...
                              <div class="drag-div-inner">
                                 <h6 id="upload_banner_image_now"><?php echo e(__('messages.UPDATE_IMAGE')); ?></h6>
                              </div>
                           </div>
                        </div>
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                           <!-- <h3 class="heading-profile-img mt-0"> <?php echo e(__('messages.UPLOAD_FROM_LIBRARY')); ?> </h3> -->
                           <div class="mCustomScrollbar max-height">
                              <div class="profile-bg ">
                                <?php if($imageLibrary): ?>
                                    <?php $__currentLoopData = $imageLibrary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imgLibRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <div data-id="<?php echo e($imgLibRow['id']); ?>" class="profile-banner-holder func-profile-banner-holder <?php if(isset($profileData['banner_image']['org_name']) == $imgLibRow['org_name']){ echo "selected-banner";}?>">
                                        <div class="banner-holder">
                                           <img src="<?php echo e(asset('/')); ?><?php echo e($imgLibRow['location']); ?>" alt="Profile Background Image">
                           ...
                           <div class="d-block mt-3">
                                 <button class="site-btn-color btn upload-lib-banner-func" type="button"><?php echo e(__('messages.UPDATE_JOB')); ?></button>
                           </div> 
                        </div>
                     </div>
               </div>
      ...
      <div class="modal custom-modal profile-modal professionalCls" id="professional-info">
         <div class="modal-dialog">
            <div class="modal-content">
               <button type="button" class="close" data-dismiss="modal"><i class="la la-times"></i></button>
               <div class="modal-body">
                  <form name="form_company_profile_info" id="form_company_profile_info" action="<?php echo e(url('/company/store-profile-info')); ?>" method="post">
                     <?php echo e(csrf_field()); ?>

                  <div class="login-form">
                     <div class="row">
                        <div class="col-sm-12 details-panel-header">
                                                    <h6><?php echo __('messages.EDIT_PROFILE_MESSAGE'); ?></h6>
                        </div>
                                             </div>
                  </div>
               </form>
...
<?php echo $__env->make('layouts.app_after_login_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/centralJobs/resources/views/frontend/company/edit.blade.php ENDPATH**/ ?>