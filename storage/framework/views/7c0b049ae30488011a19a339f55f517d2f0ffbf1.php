...
<script src="<?php echo e(asset('frontend/js/applyJob.js')); ?>"></script>
...
<link href="<?php echo e(asset('frontend/jsvideo/video-js.min.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('frontend/jsvideo/videojs.record.min.css')); ?>" rel="stylesheet">
  <!-- <link href="<?php echo e(asset('frontend/jsvideo/examples.css')); ?>" rel="stylesheet"> -->

  <script src="<?php echo e(asset('frontend/jsvideo/video.min.js')); ?>"></script>
  <script src="<?php echo e(asset('frontend/jsvideo/RecordRTC.js')); ?>"></script>
  <script src="<?php echo e(asset('frontend/jsvideo/adapter.js')); ?>"></script>

  <script src="<?php echo e(asset('frontend/jsvideo/videojs.record.min.js')); ?>"></script>

  <script src="<?php echo e(asset('frontend/jsvideo/browser-workarounds.js')); ?>"></script>
...
<?php //SET SPECIFIC QUESTIONS , ID AND ANSWER IF AVAILBLE
      ...
      if(!empty($appliedVideoAnswer)){
         foreach($appliedVideoAnswer as $key=>$val){
            ...
            array_push($interviewAns['interviewVideo'],$val['answer']);
                      ...
                      <div class="col-12"> 
                        <div class="section-myprofile">
                           <div class="mb-5 col-sm-12 details-panel-header">
                                 <h3 class="mt-0 text-center font-22 "><?php echo e(__('messages.APPLY_TO')); ?> </h3>
                           </div>
                           ...
                           <div class="row">
                              <div class="col-12 col-lg-6 border-right">
                                 <div class="sign_in_sec new_sign current">
                                    <div class="mt-md-1">
                                       <form id="candidate_login" method="POST" action="<?php echo e(url('candidate/login')); ?>" >
                                          <?php echo csrf_field(); ?>
                                          <h3>Log in</h3>                 
                                          <div class="row">
                                             <div class="col-12">
                                                <div class="sn-field">
                                                   <input type="text" id="email" class="<?php $__errorArgs = ['email'];
                                 ...
                                 <div class="sign_in_sec new_sign current sign-upfrm">
                                    <div class="tab-content">
                                       ...
                                       <div class="mt-1 password-info">
                                          ...
                                          <form id="candidate_sign_up" method="POST" action="<?php echo e(url('candidate/register')); ?>" aria-label="Register">
                                             <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> chkPasswordCls" value="<?php echo e(old('password')); ?>" type="password" name="password" id="password_org" placeholder="<?php echo e(__('messages.PASSWORD')); ?> *" title="Minimum 8 caracteres (including number, lower case, etc)">
                                                      <?php if($errors->has('password')): ?>
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="pl-0 col-12 col-md-8 for-mob-s">
                                                   <div class="p-0 col-12">
                                                      <label class="check-style fs-12"><?php echo e(__('messages.I_HAVE_READ_AND_AGREE_TO_THE')); ?> <a href="http://dev107.developer24x7.com/cnp1356/public/terms-use" target="_blank"><?php echo e(__('messages.TERMS_OF_USE')); ?></a>.
                                                      <input id="terms_conditions_status" type="checkbox" name="terms_conditions_status">
                                                      <span class="checkmark"></span>
                                                      </label>
                                                   </div>
                                                   <div class="p-0 col-12">
                                                      <label class="check-style fs-12"><?php echo e(__('messages.I_HAVE_READ_AND_AGREE_WITH_THE')); ?> <a href="http://dev107.developer24x7.com/cnp1356/public/privacy-policy" target="_blank"><?php echo e(__('messages.PRIVACY_POLICY')); ?></a>.
                                                      <input id="privacy_policy_status" type="checkbox" name="privacy_policy_status">
                                                      <span class="checkmark"></span>
                                                      </label>
                                                   </div>
                                                   <!-- <div class="p-0 col-12">
                                                      <label class="check-style fs-12"><?php echo e(__('messages.I_HAVE_READ_AND_AGREE_WITH_THE')); ?> <a href="http://dev107.developer24x7.com/cnp1356/public/cookies-policy" target="_blank"><?php echo e(__('messages.COOKIES_POLICY')); ?></a>.
                                                      <input id="cookies_policy_status" type="checkbox" name="cookies_policy_status">
                                                      <span class="checkmark"></span>
                                                      </label>
                                                   </div> -->
                                                   <div class="p-0 col-12">
                                                      <label class="check-style fs-12"><?php echo e(__('messages.I_WISH_TO_RECEIVE_NEWSLETTER')); ?> 
                           ...
                           <?php endif; ?>
                              ...
                              <input name="job_applied_id" id="job_applied_id" value="<?php echo e($jobAppliedId); ?>" type="hidden"/>
                              <input name="job_id" id="job_id" value="<?php echo e($jobId); ?>" type="hidden"/>
                             <div class="row">
                                <div class="col-sm-12 col-xl-12 apply-job-holder">
                                <div class="form-group">
                                 <label class="question-label"><?php echo e(__('messages.COVER_LETTER')); ?>:</label>
                                    <textarea  id="cover_letter" name="cover_letter"><?php echo e(isset($appliedJob) ? $appliedJob['cover_letter'] : ''); ?></textarea>
                             ...
                             <div class="mt-4 mb-5 row browse-f-sec">
                                ...
                                <label><?php echo e(__('messages.UPLOAD_CURRICULUM')); ?></label>
                                <div class="p-0 mb-2 mr-sm-2 col-sm-12 wrap-input-container form-inline">
                                       <label class="custom-file-upload form-control">
                                          <i class="fa fa-cloud-upload"></i><?php echo e(isset($uploadedCV) ? $uploadedCV->org_name : 'click here to upload your cv'); ?>
                             ...
                             <?php if(Auth::user() && Auth::user()->is_payment_done == 2): ?>
                             <div class="mt-4 mb-4 row align-items-center justify-content-between">
                                 ...
                                 <div class="mb-0 col-12 form-group">
                                    <input type="text" class="form-control" id="inputPassword2" placeholder="Enter your choice" name="highlight_sentence" value="<?php echo e(isset($profile) ? $profile->highlight_sentence : ''); ?>">
                                 </div>
                             </div>
                             <?php endif; ?>
                             <div class="mt-4 row">
                                ...
                                <!-- <button class="btn site-btn-color apply-step-one discard-aftr-1" id="save-as-draft" type="button" <?php if(Auth::user() == NULL): ?> disabled <?php endif; ?>><?php echo e(__('messages.SAVE_AS_DRAFT')); ?></button> -->
                                <?php if($jobAppliedId != ''){?>
                                  <!-- <button class="btn site-btn-color discard_job_app discard_job_app_rmvb_1" id="discard_job_app" type="button" data-id="<?php echo e($jobAppliedId); ?>" <?php if(Auth::user() == NULL): ?> disabled <?php endif; ?>><?php echo e(__('messages.DISCARD')); ?></button> -->
                                  <?php }?>
                                <?php if($jobDetails['questions']->count() == 0){?>
                                 <button class="btn site-btn-color apply-cls" id="nextbtn-cncl" type="button" <?php if(Auth::user() == NULL): ?> disabled <?php endif; ?>><?php echo e(__('messages.APPLY')); ?></button>
                                <?php }else{?>
                                <button class="btn site-btn-color rmv-cls-next" <?php if(Auth::user() == NULL): ?> disabled <?php endif; ?> id="<?php if(count($specificQuestion['question']) > 0){?>nextbtn<?php }else{?>nextbtn2<?php }?>" type="button"><?php echo e(__('messages.NEXT')); ?></button>
                                <?php }?>
                                </div>   
                             </div>
                          ...
                          <div class="login-form" id="next-specific-qus"> 
                             <div class="row">
                                <div class="col-sm-12 details-panel-header">
                                   <h4><?php echo e(__('messages.SPECIFIC_QUESTION')); ?>: </h4><p>(<?php echo e(__('messages.APPLY_JOB_SPECIFIC_QUESTION_TEXT')); ?>)</p>
                                </div>
                                <div class="col-12">
                                    <div class="interview-question-holder">
                                    <?php foreach($specificQuestion['question'] as $key=>$val){?>
                                       <div class="form-group">
                                           <label class="question-label"><?php echo e($key+1); ?>.<?php echo e($val); ?></label>
                                           <input type="hidden" name="question_id_<?php echo e($key+1); ?>" value="<?php echo e($specificQuestion['id'][$key]); ?>"/>
                                           <textarea class="form-control"  placeholder="<?php echo e(__('messages.ANS')); ?>:" name="answer_<?php echo e($key+1); ?>"><?php echo e(@$specificQuestion['answer'][$key]); ?></textarea>
                                       </div>
                                    <?php }?>
                                    </div>
                                </div>
                             ...
                             <div class="mt-4 row">
                                <div class="text-center col-12">
                                  ...
                                  <button class="btn site-btn-color" id="prevbtn" type="button" <?php if(Auth::user() == NULL): ?> disabled <?php endif; ?>><?php echo e(__('messages.PREV')); ?></button>
                                  <!-- <button class="btn site-btn-color apply-step-two discard-aftr-2" id="save-as-draft" type="button" <?php if(Auth::user() == NULL): ?> disabled <?php endif; ?>><?php echo e(__('messages.SAVE_AS_DRAFT')); ?></button> -->
                                  <?php if($jobAppliedId != ''){?>
                                  <!-- <button class="btn site-btn-color discard_job_app discard_job_app_rmvb_2" id="discard_job_app" type="button" data-id="<?php echo e($jobAppliedId); ?>" <?php if(Auth::user() == NULL): ?> disabled <?php endif; ?>><?php echo e(__('messages.DISCARD')); ?></button> -->
                                  <?php }?>
                                  <?php if(!empty($interviewQuestion['question'])){ ?>   
                                  <button class="btn site-btn-color" id="nextbtn2" type="button" <?php if(Auth::user() == NULL): ?> disabled <?php endif; ?>><?php echo e(__('messages.NEXT')); ?></button>
                                  <?php }else{?>
                                    <button class="btn site-btn-color apply-cls" id="nextbtn2-cncl" type="button" <?php if(Auth::user() == NULL): ?> disabled <?php endif; ?>><?php echo e(__('messages.APPLY')); ?></button>
                                  <?php }?>
                                </div>
                             </div>
                          ...
                          <div class="login-form" id="next-interview-qus"> 
                             <div class="row">
                             <div class="col-sm-12 details-panel-header">
                                   <h4 class="mb-4"><?php echo e(__('messages.VIDEO_QUESTION')); ?></h4>
                                   <div class="info-holder">
                                       <div class="row">
                                          <div class="mb-3 col-sm-12">
                                             <h4 class="text-left"> <?php echo e(__('messages.VIDEO_QUESTION_SEC_1')); ?>  </h4>
                                          </div>
                                          <div class="mb-3 col-sm-12">
                                             <h4 class="text-left"> <?php echo e(__('messages.VIDEO_QUESTION_SEC_2')); ?>  </h4>
                                          </div>
                                          <div class="col-sm-12 col-xl-12">
                                          
                                          <h5 class="total-title"> <?php echo e(__('messages.VIDEO_QUESTION_SEC_3')); ?> </h5>
                                          <p><i class="mr-2 fa fa-paper-plane-o" aria-hidden="true"></i> <?php echo e(__('messages.VIDEO_QUESTION_SEC_3_1')); ?> </p>
                                          <p><i class="mr-2 fa fa-paper-plane-o" aria-hidden="true"></i> <?php echo e(__('messages.VIDEO_QUESTION_SEC_3_2')); ?> </p>
                                          <p><i class="mr-2 fa fa-paper-plane-o" aria-hidden="true"></i> <?php echo e(__('messages.VIDEO_QUESTION_SEC_3_3')); ?></p>
                                          <p><i class="mr-2 fa fa-paper-plane-o" aria-hidden="true"></i> <?php echo e(__('messages.VIDEO_QUESTION_SEC_3_4')); ?>  </p>
                                          <p><i class="mr-2 fa fa-paper-plane-o" aria-hidden="true"></i> <?php echo e(__('messages.VIDEO_QUESTION_SEC_3_5')); ?>  </p>
                                          <p><i class="mr-2 fa fa-paper-plane-o" aria-hidden="true"></i> <?php echo e(__('messages.VIDEO_QUESTION_SEC_3_6')); ?>  </p>
                                          <p><i class="mr-2 fa fa-paper-plane-o" aria-hidden="true"></i> <?php echo e(__('messages.VIDEO_QUESTION_SEC_3_7')); ?>  </p>

                                          <h5 class="mt-4 total-title"> <?php echo e(__('messages.VIDEO_QUESTION_SEC_4')); ?></h5>
                                          <p>  <?php echo e(__('messages.VIDEO_QUESTION_SEC_4_1')); ?></p>
                                          </div>
                                ...
                                <!-- <div class="col-sm-12 details-panel-header">
                                   <h4 class="mb-4"><?php echo e(__('messages.INTERVIEW_QUESTIONS')); ?>:</h4>
                                   <h5 class="total-title"><?php echo e(__('messages.PAY_ATTENTION_THIS_COMPANY_REQUESTED')); ?>  "<?php echo e($mandetory); ?>"</h5>
                                   <h5 class="form-sub-heading"><i>"<?php echo e(__('messages.TO_ANSWER_AN_INTERVIEW_QUESTION_YOU_NEED_TO_ACTIVATE_THE_QUESTION')); ?>" </i><a class="ml-2" data-toggle="modal" data-target="#tips-interview"><i class="fa fa-question-circle" aria-hidden="true"></i></a> </h5>
                                   <div class="info-holder">
                                       <div class="row">
                                          <div class="mb-3 col-sm-12">
                                             <h4 class="text-left"> <?php echo e(__('messages.APPLY_JOB_STEP3_TIPS_TEXT1')); ?>  </h4>
                                          </div>
                                          <div class="col-sm-12 col-xl-12">
                                          
                                          <h5 class="total-title"> <?php echo e(__('messages.APPLY_JOB_STEP3_TIPS_TEXT2')); ?> </h5>
                                          <p><i class="mr-2 fa fa-paper-plane-o" aria-hidden="true"></i> <?php echo e(__('messages.APPLY_JOB_STEP3_TIPS_TEXT3')); ?> </p>
                                          <p><i class="mr-2 fa fa-paper-plane-o" aria-hidden="true"></i> <?php echo e(__('messages.APPLY_JOB_STEP3_TIPS_TEXT4')); ?> </p>
                                          <p><i class="mr-2 fa fa-paper-plane-o" aria-hidden="true"></i> <?php echo e(__('messages.APPLY_JOB_STEP3_TIPS_TEXT5')); ?></p>
                                          <p><i class="mr-2 fa fa-paper-plane-o" aria-hidden="true"></i> <?php echo e(__('messages.APPLY_JOB_STEP3_TIPS_TEXT6')); ?>  </p>

                                          <h5 class="mt-4 total-title"> <?php echo e(__('messages.OUR_SUGGESTION')); ?>:</h5>
                                          <p>  <?php echo e(__('messages.APPLY_JOB_STEP3_TIPS_TEXT7')); ?></p>

                                             <h6 class="h5-title">** <?php echo e(__('messages.APPLY_JOB_STEP3_TIPS_TEXT8')); ?> <?php echo e(count($interviewQuestion['question'])); ?> <?php echo e(__('messages.INTERVIEW_QUESTIONS')); ?>.  </h6>
                                    ...
                                    <div class="interview-question-holder">
                                       ...
                                       <div class="mb-5 form-group">
                                          <div class="mb-4 d-flex"> 
                                             <label class="mb-0 page-title"><?php echo e(__('messages.QUESTION')); ?> : <span>  <?php echo e(__('messages.DO_YOU_WANT_TO_ACTIVE_QUESTION')); ?> </span> </label>
                                             
                                             <!-- <div class="switch-slider timerButtons">
                                               <label class="switch">
                                                  <input id="start_vid_<?php echo e($key); ?>" type="checkbox" <?php //if(!empty($attemptArr[$interviewQuestion['id'][$key]])){ echo 'checked disabled';} ?> class="start_vid_<?php echo e($key); ?>">
                                             ...
                                             <div class="switch-slider timerButtons">
                                               <label class="switch">
                                                  <input id="start_vid_interview_<?php echo e($key); ?>" type="checkbox" <?php if(!empty($attemptArr[$interviewQuestion['id'][$key]])){ echo 'checked disabled';} ?> class="start_vid_interview_<?php echo e($key); ?>">
                                                  <span class="slider round"></span>
                                               </label>
                                             </div>  
                                          ...
                                          <div class="show_hide_question_interview_<?php echo e($key); ?>" style="<?php  if(!empty($attemptArr[$interviewQuestion['id'][$key]])){ echo 'display:block';}else{ echo 'display:none';}?>">
                                          <div class="d-flex justify-content-between">
                                                <h5 class="my-0 h5-title">Q: <?php echo e(@$val); ?></h5>
                                            </div>
                                          <div id="mycustom-container" style="opacity:0;margin-top: 20px;"></div>
                                          <input type="hidden" id="video_question_id_<?php echo e($key+1); ?>" name="video_question_id_<?php echo e($key+1); ?>" value="<?php echo e($interviewQuestion['id'][$key]); ?>"/>
                                          <input type="hidden" id="video_answer_<?php echo e($key+1); ?>" name="video_answer_<?php echo e($key+1); ?>" value=""/>
                                            </div>

                                          <div class="show_hide_question_<?php echo e($key); ?>" style="<?php  if(!empty($attemptArr[$interviewQuestion['id'][$key]])){ echo 'display:block';}else{ echo 'display:none';}?>">
                                             <div class="d-flex justify-content-between">
                                                <!-- align-items-center -->
                                                <h5 class="my-0 h5-title">Q: <?php echo e(@$val); ?></h5>
                                                <input type="hidden" id="video_question_id_<?php echo e($key+1); ?>" name="video_question_id_<?php echo e($key+1); ?>" value="<?php echo e($interviewQuestion['id'][$key]); ?>"/>
                                                <div class="text-center w-110">
                                                   <div id="timeContainer" class="well well-sm">
                                                    <?php if(count($attemptArr[$interviewQuestion['id'][$key]]) < 3){?>
                                                      <time id="timerValue" class="timerValue_<?php echo e($key); ?>">00:00:00</time>
                                                    <?php }?>
                                                   </div>
                                                </div>  
                                             </div> 
                                          </div>   
                                          <div class="show_hode_<?php echo e($key); ?>" style="<?php if(!empty($attemptArr[$interviewQuestion['id'][$key]])){ echo 'display:block';}else{ echo 'display:none';}?>">

                                             <div class="interview-video-holder">
                                                <div class="d-flex flex-wrap justify-content-between">
                                                <!-- align-items-center -->
                                                   <h5 class="my-0 h5-title mb-2"><?php echo e(__('messages.TELL_US')); ?></h5>
                                                   <!-- media-action -->
                                                      <div class="media-action">
                                                         ...
                                                         <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                                            ...
                                                            <div class="actionicon-box-item media align-items-center">
                                                               ...
                                                               <div class="media-body">
                                                               <?php echo e(__('messages.TO_VIEW')); ?>
                                                ...
                                                <div class="interview-video-generator" id="video_intro_form_<?php echo e($key); ?>">
                                                   <?php if(@$interviewQuestion['interviewVideo'][$interviewQuestion['id'][$key]] != ''){ ?> 
                                                   <div id="divVideo">    
                                                   <video   controls class="video-js vjs-default-skin reset_upload_<?php echo e($key); ?>" >
                                                      
                                                         <source class="checked-video-cls-<?php echo e($key); ?>" src="<?php echo e(asset(@$interviewQuestion['interviewVideo'][$interviewQuestion['id'][$key]])); ?>" type="video/mp4">
                                                                                                                                             
                                                   </video>
                                                   </div>
                                                   <video id="myVideo_<?php echo e($key); ?>" playsinline class="video-js vjs-default-skin vjs-hidden" >
                                                      ...
                                                      <?php }else if(!empty($attemptArr[$interviewQuestion['id'][$key]])){ $endValueArr = end($attemptArr[$interviewQuestion['id'][$key]]); ?>
                                                        ...
                                                        <video   controls class="video-js vjs-default-skin reset_upload_<?php echo e($key); ?>" >
                                                         ...
                                                         <source class="checked-video-cls-<?php echo e($key); ?>" src="<?php echo e(asset($endValueArr['location'])); ?>" type="video/mp4">
                                                     ...
                                                     <?php }
                                                      ...
                                                      <div id="divVideo" style="display:none;">   
                                                        <video   controls class="video-js vjs-default-skin reset_upload_<?php echo e($key); ?>" >
                                                         ...
                                                         <source class="checked-video-cls-<?php echo e($key); ?>" src="" type="video/mp4">
                                                                                                                                             
                                                        </video>
                                                       </div>
                                                      <video id="myVideo_<?php echo e($key); ?>" playsinline class="video-js vjs-default-skin">
                                           ...
                                           <p class="mb-0 mt-3 add_text_alert_<?php echo e($key); ?>">
                                           <?php if(!empty($attemptArr[$interviewQuestion['id'][$key]])){ ?>
                                           <?php echo e(__('messages.SELECT_ONO_OF_VIDEOS_BELOW_YOU_CAN_TRY_3_TIMES')); ?>
                                         ...
                                         <div class="flex-wrap d-flex justify-content-between "> 
                                                ...
                                                <div class="select-newstyle">
                                                      <input type="hidden" id="count-atteched-<?php echo e($key+1); ?>" name="count-atteched-<?php echo e($key+1); ?>" value="<?php echo e(count($attemptArr[$interviewQuestion['id'][$key]])); ?>"/> 
                                                            <div class="flex-wrap list-inline-item d-flex" id="all-atteched-video-<?php echo e($key); ?>">
                                                         ...
                                                         foreach($attemptArr[$interviewQuestion['id'][$key]] as $index=>$data){ ?>
                                                               ...
                                                               ?>
                                                               <input type="radio" class="chk-video-cls disable-cls-redio-<?php echo e($key); ?>" data-id="<?php echo e($data['id']); ?>" data-no="<?php echo e($key); ?>" id="attempt-<?php echo e($index+1); ?>" name="attempt_question_<?php echo e($key+1); ?>" value="<?php echo e($data['id']); ?>"  <?php if($data['is_selected'] == 1){ echo 'checked';}else if($lastIndex == $index){ echo 'checked';} ?>>
                                                               <span class="checkmark"></span>
                                                               </label>
                                                               <?php }
                                                         }?>
                                                ...
                                                <div id="timerButtons" class="flex-wrap mx-0 mt-2 d-flex">
                                                   <button type="button"  id="stop-<?php echo e($key); ?>" class="mb-2 mr-2 btn btn-danger min-w-130" style="<?php if(count($attemptArr[$interviewQuestion['id'][$key]]) == 0){ echo 'display:block'; }else{ echo 'display:none'; }?>" ><?php echo e(__('messages.STOP')); ?></button>
                                                   <button type="button"  id="start-<?php echo e($key); ?>" class="mb-2 btn site-btn-color min-w-130" style="<?php if((!empty($attemptArr[$interviewQuestion['id'][$key]])) && count($attemptArr[$interviewQuestion['id'][$key]]) < 3){ echo 'display:block'; }else{ echo 'display:none'; }?>"><?php echo e(__('messages.RESTART')); ?></button>
                                                </div> 
                                         </div>       
                             ...
                             <div class="mt-4 row">
                                ...
                                <label style="display: none;" class="error upload-error-n-intro"> Error Message </label>
                                 <button class="btn site-btn-color enable-disable-cls-prev" id="<?php if(count($specificQuestion['question']) == 0){?>prevbtn<?php }else{?>prevbtn2<?php }?>" type="button" <?php if(Auth::user() == NULL): ?> disabled <?php endif; ?>><?php echo e(__('messages.PREV')); ?></button>
                                  <!-- <button class="btn site-btn-color apply-step-three upload-intro-video-func enable-disable-cls discard-aftr-3" id="save-as-draft" type="button" data-id="0" <?php if(Auth::user() == NULL): ?> disabled <?php endif; ?>><?php echo e(__('messages.SAVE_AS_DRAFT')); ?></button> -->
                                  <?php if($jobAppliedId != ''){?>
                                  <!-- <button class="btn site-btn-color discard_job_app enable-disable-cls discard_job_app_rmvb_3" id="discard_job_app" type="button" data-id="<?php echo e($jobAppliedId); ?>" <?php if(Auth::user() == NULL): ?> disabled <?php endif; ?>><?php echo e(__('messages.DISCARD')); ?></button> -->
                                  <?php }?>
                                  <button class="btn site-btn-color upload-intro-video-func enable-disable-cls" type="button" data-id="1" <?php if(Auth::user() == NULL): ?> disabled <?php endif; ?>><?php echo e(__('messages.APPLY')); ?></button>
                                </div>
                             </div>
                          </div>
                           <?php }?>
      ...
      <!-- main End -->
      <!--footer start-->
      <script src="<?php echo e(asset('frontend/js/dropzone.min.js')); ?>"></script>
      ...
      <script src="<?php echo e(asset('frontend/js/tagsinput.js')); ?>"></script> 
      ...
      <script src="https://embed.myinterview.com/widget/2.38.0/widget.js"></script>
      <script>
        
        $('#start_vid_interview_0').click(function(){
     if($(this).is(":checked"))
     {
      swal({
      ...
      .then((willDelete) => {
         if (willDelete) {
            $('.show_hide_question_interview_0').show('slow');
            //$("input.start_vid_interview_0").attr("disabled", true);
            ...
            config: {
              apiKey: "dy7lpre2xi44rq2l5oibv8ie",
              button: {
                text: "Start Recording"
              },
              practice: false,
              disableWebcamTest: true,
              overlay: "",
              hideQuestions: false,
              countDownTime: 40,
              user: {
              ...
              completeCallback: function(videoID){
                ...
                $('#video_answer_1').val(videoID);
                //console.log('Finished recording with id: '+ videoID);
              },
              popupClosed: function(){
                $(".enable-disable-cls").attr("disabled", false);
                $(".enable-disable-cls-prev").attr("disabled", false);
                $("input.start_vid_interview_0").attr("disabled", false);
              },
              parts: [
                //Complete example
                {
                  question: '<?php echo $interviewQuestion['question'] ? $interviewQuestion['question'][0] : "" ?>', // the question of this part of the interview
                  partDuration: 120, // the duration of this part of the interview in seconds
                  ...
                  numOfRetakes: 3 // the number of retakes the user may take for a single part
                },
              ]
            }
          });
          ...
          myInterviewRecorder.openPopup();
          }, 1000)     */

        }else{
              $("#start_vid_interview_0").prop("checked", false);
          }   
      })  
     }else{
      $('.show_hide_question_interview_0').hide('slow');
      $(".enable-disable-cls").attr("disabled", false);
      $(".enable-disable-cls-prev").attr("disabled", false);
     }
   });
...
<?php echo $__env->make('layouts.app_after_login_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/centralJobs/resources/views/frontend/candidate/applyJob.blade.php ENDPATH**/ ?>