                     ...
                     <tbody>
                        <tr>
                           <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#999;font-size:13px;line-height:1.6; padding:20px 0" align="center">
                               <a href="<?php echo e(env('APP_URL')); ?>" target="_blank"><img src="<?php echo e(asset('frontend/images/OFFICIAL_LOGO_emails.jpeg')); ?>" alt="" style="max-width: 180px"></a>
                           </td>
                        </tr>
                     </tbody>
                  </table>
                                 ...
                                 <tbody>
                                    <tr>
                                       <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#444;font-size:14px;line-height:150%" valign="top">
                                          ...
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Mensagem recebida com sucesso.</p></br>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Name: <?php echo e($userData['name']); ?> </p> </br>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">E-mail: <?php echo e($userData['email']); ?></p> </br>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Tipe de mensagem : <?php echo e($userData['subject']); ?></p> </br>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Mensagem: <?php echo e($userData['description']); ?></p> </br>
...
<?php /**PATH /var/www/html/centralJobs/resources/views/email/contactUsAdmin.blade.php ENDPATH**/ ?>