                                                   ...
                                                   <tr>
                                                      <td>
                                                         <h1 style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif;color:#444; display:block; font-size:15px; font-weight:600;line-height:1.5; margin:0">
                                                            Sehr geehrte <?php echo e($user['name']); ?>,
                                                         </h1>
                                                      </td>
                                                   </tr>
                                                </tbody>
                                             ...
                                             <tbody>
                                                <tr>
                                                   <td style="border-radius:3px;" bgcolor="#ffc00" align="center">
                                                      <a href="<?php echo e(url('password/reset/'.$RememberToken.'?email='.$user['email'])); ?>" style="padding: 0.8rem 1.2rem; text-decoration: none; display: inline-block; font-size: 14px; border-radius: 3px; color: #0b0001; border:none; background: #ffc000; ">Passwort zurücksetzen</a>    
                                                   </td>
                                                </tr>
                                             </tbody>
                                          </table>
...
<?php /**PATH /var/www/html/centralJobs/resources/views/email/forgotPasswordFrontend.blade.php ENDPATH**/ ?>