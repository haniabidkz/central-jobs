...
<script src="<?php echo e(asset('frontend/js/follow.js')); ?>"></script>
                  ...
                  <div class="container">
                     <div class="row">
                        <div class="col-12 col-lg-4 col-xl-3">
                           <div class="profile-side-panel">
                              <div class="details-panel-header mb-3">
                                 <div class="profile-img-holder">
                                    <div class="profile-bg-img">
                                       ...
                                       <img src="<?php echo e(asset($profileData['bannerImage']['location'])); ?>" alt="user-profile-bg">
                                       <?php }else{?>
                                          <img src="<?php echo e(asset('frontend/images/user-pro-bg-img.jpg')); ?>" alt="user-profile-bg">
                                       <?php }?>
                                    </div>
                                    <div class="profile-img">
                                       <?php if($profileData['profileImage'] != null){?>
                                       <img src="<?php echo e(asset($profileData['profileImage']['location'])); ?>" alt="user-profile">
                                        <?php }else{?>
                                          <img src="<?php echo e(asset('frontend/images/user-pro-img-demo.png')); ?>" alt="user-profile">
                                        <?php }?>
                                    </div>
                                 </div>
                                 <h3 class="h3-profile"><?php echo ($profileData['company_name']?$profileData['company_name']:'');?></h3>
                                 <h5 class="text-company"><?php echo e(isset($profileData['profile']['business_name'])?$profileData['profile']['business_name']:''); ?>

                                    <?php //echo ($profileData['profile']['business_name']?$profileData['profile']['business_name']:'');?>
                                 </h5>
                                 <h6 class="color-lightgray">
                                    <?php echo e(isset($profileData['state']['name'])?$profileData['state']['name']:''); ?> , <?php echo e(isset($profileData['country']['name'])?$profileData['country']['name']:''); ?>
                              ...
                              <div class="user_pro_status pb-2 mb-3">
                                 <h3 class="text-center"><span><?php echo e(__('messages.FOLLOWERS')); ?> <b id="total-follow-<?php echo e($profileData['id']); ?>"><?php echo e($allFollowers); ?></b></span></h3>
                              </div>
                              ...
                              <div class="profile-btn-holder d-flex">
                                 ...
                                 <button class="btn site-btn-color mr-2 w-100 follow-unfollow-user-<?php echo e($profileData['id']); ?>" id="follow-unfollow-user" data-id="<?php echo e($profileData['id']); ?>" <?php if(!empty($followUnfollowArr) && (in_array(Auth::user()->id,$followUnfollowArr))){ ?>data-follow="0"<?php }else{ ?> data-follow="1"<?php }?>><?php if(!empty($followUnfollowArr) && (in_array(Auth::user()->id,$followUnfollowArr))){ echo __('messages.UN_FOLLOW');}else{ echo __('messages.FOLLOW');}?></button> 
                                 <?php }else{ ?>
                                    <button class="btn site-btn-color mr-2 w-100" href="<?php echo e(url('/')); ?>"><?php echo e(__('messages.FOLLOW')); ?></button> 
                                    <?php }?>
                                 <div class="dropdown msg-dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                       ...
                                       <a class="dropdown-item" href="javascript:void(0);" id="report-company-id" data-id="<?php echo e($profileData['id']); ?>"><?php echo e(__('messages.REPORT')); ?></a>
                                       <?php }else if(($user_type_id == 2) && (Auth::user()) && (in_array(Auth::user()->id,$isReported))){?>
                                          <a class="dropdown-item"  href="javascript:void(0);" style="cursor:default;" disabled><?php echo e(__('messages.REPORTED')); ?></a>
                                       <?php }
                                       else{?>
                                          <a class="dropdown-item"  href="<?php echo e(url('/')); ?>" ><?php echo e(__('messages.REPORT')); ?></a>
                                       <?php } ?>
                              ...
                              <?php }else{?>
                                    <div class="profile-btn-holder d-flex">
                                    <button class="btn site-btn-color w-100 mr-2 block_user" data-id="<?php echo e($profileData['id']); ?>" data-block="0" id="block_user_<?php echo e($profileData['id']); ?>"><?php echo e(__('messages.UN_BLOCK')); ?></button>    
                                    </div>
                                 <?php } }?>
                              ...
                              <button class="btn site-btn-color w-100 mr-2" id="" data-id="<?php echo e($profileData['id']); ?>" style="cursor:default;">Active</button>     
                              <?php }else{?>
                                 <button class="btn site-btn-color w-100 mr-2" id="" data-id="<?php echo e($profileData['id']); ?>" style="cursor:default;">Inactive</button>       
                              <?php }?>
                                    </div>
                                 <?php }?>
                           </div>
                        ...
                        <div class="col-12 col-lg-8 col-xl-9">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-12 col-sm-12 col-md-6">
                                          <div class="form-view">
                                             ...
                                             <?php echo e(isset($profileData['country']['name'])?$profileData['country']['name']:''); ?>
                                       ...
                                       <div class="col-12 col-sm-12 col-md-6">
                                          <div class="form-view">
                                             ...
                                             <?php echo e(isset($profileData['state']['name'])?$profileData['state']['name']:''); ?>
                           ...
                           <input type="hidden" name="page" id="page" value="<?php echo e($search['page']); ?>"/>
                           <input type="hidden" name="slug" id="slug" value="<?php echo e($profileData['slug']); ?>"/>
                           
                           <?php $isBlockUser = Helper::checkBlockUser($profileData['id']); 
                           if(empty($isBlockUser)){
                           ?>
                           <div class="row" id="post-data">
                           <div class="col-12"> <h4 class="total-title"> <?php echo e(__('messages.RECENT_POST')); ?> </h4></div>
                           <?php echo $__env->make('frontend.company.postData', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                           <?php if($postData->count() == 0){?>
                           <div class="col-12">
                              <div class="post-coming">
                                 <p class="mb-0"> <?php echo e(__('messages.NEW_POST_COMING_SOON')); ?>......</p>
                              </div>
                           </div>
                           <?php }?>
                  ...
                  <div class="login-form">
                     <div class="row">
                        ...
                        <div class="col-12 ext-left">
                           <button class="btn site-btn-color report-submit-btn" type="submit"><?php echo e(__('messages.SUBMIT')); ?></button>
                        </div>
                     </div>
                  </div>
                  </form>
     ...
     <div class="modal custom-modal profile-modal report-company-modal" id="report-company-modal">
         <div class="modal-dialog">
            <div class="modal-content">
               <button type="button" class="close" data-dismiss="modal"><i class="la la-times"></i></button>
               <div class="modal-body">
               <form id="report_company" action="<?php echo e(url('/candidate/report-company')); ?>" method="post" >
                     <?php echo e(csrf_field()); ?>
                  ...
                  <div class="login-form">
                     <div class="row">
                        ...
                        <div class="col-12 ext-left">
                           <button class="btn site-btn-color report-submit-btn report-company-cls" type="submit"><?php echo e(__('messages.SUBMIT')); ?></button>
                        </div>
                     </div>
                  </div>
                  </form>
                                    ...
                                    <div class="media-body">
                                       <?php if(Auth::user()->user_type == 2): ?>
                                          ...
                                          <p class="post-location">
                                             <?php if(isset(Auth::user()->currentCompany['title']) && Auth::user()->currentCompany['title'] !=''): ?>
                                              <?php echo e(Auth::user()->currentCompany['title']); ?> at <?php echo e(Auth::user()->currentCompany['company_name']); ?>

                                             <?php endif; ?>
                                          </p>
                                       <?php elseif(Auth::user()->user_type == 3): ?>
                                          <h5 class="post-name"><?php echo e(Auth::user()->company_name); ?></h5>
                                          <p class="post-location"><?php echo e(isset(Auth::user()->profile['business_name'])?Auth::user()->profile['business_name']:''); ?></p>
                                       <?php endif; ?>
...
<?php echo $__env->make('layouts.app_after_login_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/centralJobs/resources/views/frontend/company/view.blade.php ENDPATH**/ ?>