                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-sm-12">
                            <h2><?php echo e(strip_tags(@$data[0]['text'])); ?></h2>                
                        </div>
                    </div>
                </div>
            </div>                  
...
<?php echo $__env->make('layouts.app_after_login_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/centralJobs/resources/views/frontend/cms/cookies.blade.php ENDPATH**/ ?>