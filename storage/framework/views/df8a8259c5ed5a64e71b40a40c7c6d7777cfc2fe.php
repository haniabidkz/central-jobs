                              ...
                              <div class="row mb-4">
                                <div class="col-12 col-lg-3">
                                    ...
                                    <div class="profile-side-panel">
                                       <div class="details-panel-header border-bottom-0 pb-0 mb-2">
                                          <div class="profile-img-holder">
                                             <div class="profile-bg-img">
                                                ...
                                                <?php if(!empty($userProfInfo['bannerImage'])): ?>
                                                   <img class="profile-image-src-menu" id="profile-image-src-menu" src="<?php echo e(asset($userProfInfo['bannerImage']['location'])); ?>" alt="">
                                                <?php else: ?>
                                          ...
                                          <div class="profile-btn-holder">
                                             <?php if($userProfInfo['user_type'] == 3){?>
                                                <a href="<?php echo e(url('company/my-profile')); ?>" class="btn site-btn-color w-100"> <?php echo e(__('messages.EDIT_PROFILE')); ?></a> 
                                             <?php }else if($userProfInfo['user_type'] == 2){?>
                                                <a href="<?php echo e(url('candidate/my-profile')); ?>" class="btn site-btn-color w-100"> <?php echo e(__('messages.EDIT_PROFILE')); ?></a> 
                                             <?php }?>
                                          </div>
                                       ...
                                       <div class="create-post-holder-pos">
                                          <!-- <h4 class="page-title"> <?php echo e(__('messages.CREATE_POST')); ?> </h4> -->
                                          <div class="create-post-holder ">
                                          <?php if($userProfInfo['user_type'] == 3){?>
                                             <a
                                             href="<?php echo e(url('company/my-jobs')); ?>"
                                             class="btn site-btn-color w-100 mt-3">
                                             <?php echo e(__('messages.MANAGE_YOUR_JOB_POST')); ?>

                                             </a>
                                             <!-- <div class="manage-job-post">
                                                   <a href="<?php echo e(url('company/my-jobs')); ?>" > 
                                          ...
                                          <?php }?>
                                                ...
                                                <!-- <div class="create-post" data-toggle="modal" data-target="#create-text-post-modal">
                                                   <a class="create-icon"> <i class="fa fa-pencil-square" aria-hidden="true"></i> </a>
                                                   <?php echo e(__('messages.WRITE_A_POST')); ?>
                                                ...
                                                <div class="create-post" data-toggle="modal" data-target="#create-img-post-modal">
                                                   ...
                                                   <?php echo e(__('messages.POST_AN_IMAGE')); ?>
                                                ...
                                                <div class="create-post" data-toggle="modal" data-target="#create-video-post-modal">
                                                   ...
                                                   <?php echo e(__('messages.POST_A_VIDEO')); ?>
                                ...
                                <div class="col-12 col-lg-9">
                                    ...
                                    <?php if($postRow['category_id'] == 1): ?>                                   
                                        <?php echo $__env->make('frontend.post.jobpost', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php endif; ?> 

                                    <?php if($postRow['category_id'] == 2): ?>
                                        <?php echo $__env->make('frontend.post.textpost', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php endif; ?>

                                    <?php if($postRow['category_id'] == 3): ?>                                   
                                        <?php echo $__env->make('frontend.post.imagepost', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php endif; ?> 

                                    <?php if($postRow['category_id'] == 4): ?>                                   
                                        <?php echo $__env->make('frontend.post.videopost', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php endif; ?> 
                                 ...
                                 echo $postData->appends(request()->query())->onEachSide(1)->links() ;
                                    ...
                                    <!--  nodata-found-holder -->
                                       <div class="nodata-found-holder">
                                          <img src="<?php echo e(asset('frontend/images/warning-icon.png')); ?>" alt="">
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <div class="login-form">
                     <form action="<?php echo e(url('/store-text-post')); ?>" method="post" id="text_post" enctype="multipart/form-data">
                        <?php echo e(csrf_field()); ?>

                        
                     <div class="row">
                        <div class="col-12 details-panel-header">
                           <h4 class="text-left"><?php echo e(__('messages.CREATE_POST')); ?></h4>
                        </div>
                        <div class="col-12">
                           <div class="form-group required">
                              <label class="question-label"><?php echo e(__('messages.WRITE_SOMETHING_TO_SHARE')); ?></label>
                              <textarea class="form-control" name="description" id="description"></textarea>
                           </div>
                           
                        </div>
                        <div class="col-12 text-left">
                           <button class="btn site-btn-color" type="submit"><?php echo e(__('messages.POST')); ?></button>
                        </div>
                     </div>
                     </form>
                  </div>
      ...
      <div class="modal custom-modal profile-modal dashboard-modal" id="create-img-post-modal">
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <div class="login-form">
                  <form action="<?php echo e(url('/store-image-post')); ?>" method="post" id="image_post" enctype="multipart/form-data">
                        <?php echo e(csrf_field()); ?>
                  ...
                  <div class="login-form">
                     <div class="row">
                        ...
                        <div class="col-12 ext-left">
                           <button class="btn site-btn-color report-post-cls" type="submit"><?php echo e(__('messages.SUBMIT')); ?></button>
                        </div>
                     </div>
                  </div>
                  </form>
                                 ...
                                 <input type="hidden" name="post_id" id="post_id" value=""/>
                                    <div class="message-send-form-holder media">
                                       <div class="message-send-input-box media-body">
                                          ...
                                          <textarea class="form-control h-44" name="comment" placeholder="<?php echo e(__('messages.COMMENT')); ?>"></textarea>
                                       </div>
                           ...
                           <div class="share-post-block-holder function-share-post-block-holder">
                              <div class="post-block">
                                 <div class="media">
                                    ...
                                    <?php if(!empty($userProfInfo['profileImage']) && !is_null($userProfInfo['profileImage'])): ?>
      ...
      <div class="modal custom-modal profile-modal dashboard-modal" id="create-any-post-modal">
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <div class="login-form">
                  <form action="<?php echo e(url('/store-any-post')); ?>" method="post" id="any_post" enctype="multipart/form-data">
                        <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layouts.app_after_login_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/centralJobs/resources/views/frontend/candidate/dashboard.blade.php ENDPATH**/ ?>