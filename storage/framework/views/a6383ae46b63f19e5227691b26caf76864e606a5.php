...
<script src="<?php echo e(asset('backend/dist/js/bootstrap-datetimepicker.min.js')); ?>"></script>
<link rel="stylesheet" href="<?php echo e(asset('backend/dist/css/bootstrap-datetimepicker.css')); ?>">   
 <!-- main -->
 <main>
                    ...
                    <div class="bennertext">
                        <div class="innertitle">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                                        <h2><?php echo e(strip_tags(@$data[5]['text'])); ?></h2>                
                                    </div>
                                </div>
                            </div>
                        </div>                  
            ...
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <div class="login-form">
                    <form name="form_service_info" id="form_service_info" action="<?php echo e(url('/candidate/store-service-info')); ?>" method="post">
                      
                     <?php echo e(csrf_field()); ?>

                     <div class="row">
                        <div class="col-sm-12 details-panel-header">
                           <!-- <h4 class="text-left"><?php echo e(__('messages.EDIT_PROFESSIONAL_EXPERIENCE')); ?></h4>
                        ...
                        <div class="col-12 col-sm-6 col-xl-6">
                           ...
                           <input type="hidden" name="subscription_id" id="subscription_id" value="3"/>
                              <select class="form-control" id="service_name" name="service_name" disabled>
                                 <option value=""><?php echo e(__('messages.SERVICE_NAME')); ?></option>
                                 <?php if(count($subscriptions) > 0): ?>
                                <?php $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val['id']); ?>" <?php if($val['id'] == 3){ echo 'selected';}?>><?php echo e($val['title']); ?></option>
                        ...
                        <div class="col-12 col-sm-6 col-xl-6">
                           <div class="form-group required">
                              <input class="form-control" placeholder="<?php echo e(__('messages.CANDIDATE_NAME')); ?>" type="text" id="candidate_name" name="candidate_name" value="<?php echo e($name); ?>">
                           </div>
                        </div>
                        <div class="col-12 col-sm-6 col-xl-6">
                           <div class="form-group required">
                              <input class="form-control" placeholder="<?php echo e(__('messages.CANDIDATE_EMAIL')); ?>" type="text" id="candidate_email" name="candidate_email" value="<?php echo e($email); ?>">
                           </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-xl-6">
                           <div class="form-group required">
                              <div class="select-dat">
                                 <input type="text" class="form-control" placeholder="<?php echo e(__('messages.PROPOSE_DATE_TIME_ONE')); ?>" id="service_start_from" name="service_start_from"  value="" autocomplete="off">
                              </div>
                           </div>
                        </div>
                        <div class="col-12 col-sm-6 col-xl-6">
                           <div class="form-group required">
                              <div class="select-dat">
                                    <input type="text" class="form-control" placeholder="<?php echo e(__('messages.PROPOSE_DATE_TIME_TWO')); ?>" id="propose_date_2" name="propose_date_2"  value="" autocomplete="off">
                              </div>
                           </div>   
                        </div>
                        <div class="col-12 col-sm-6 col-xl-6">
                           <div class="form-group required">
                              <div class="select-dat">
                                    <input type="text" class="form-control" placeholder="<?php echo e(__('messages.PROPOSE_DATE_TIME_THREE')); ?>" id="propose_date_3" name="propose_date_3"  value="" autocomplete="off">
                              </div>
                           </div>   
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <label class="check-style"><?php echo e(__('messages.I_HAVE_READ_AND_AGREE_WITH_THE')); ?> <a href="<?php echo e(url('terms-use')); ?>" target="_blank" ><?php echo e(__('messages.COOKIES_POLICY')); ?></a>.
                        ...
                        <div class="col-12">
                           <div class="form-group">
                              <button class="site-btn btn submit-service-btn" type="submit" ><?php echo e(__('messages.SUBMIT')); ?></button>
                           </div>
                        </div>
                     </div>
                   </form>
...
<?php echo $__env->make('layouts.app_after_login_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/centralJobs/resources/views/frontend/cms/service.blade.php ENDPATH**/ ?>