               ...
               <div class="login-form">
                  <div class="row mb-4">
                     <div class="col-12 col-sm-8">
                        <h4 class="page-title"><?php echo e(__('messages.SEARCH_PREVIOUS_JOB_POST_HERE')); ?></h4> 
                     </div>
                     <div class="col-12 col-sm-4 text-sm-right">
                        <?php if(Auth::user()->user_type == 3){?>
                        <a class="btn site-btn-color" href="<?php echo e(url('company/post-job')); ?>"><?php echo e(__('messages.POST_JOB')); ?></a>
                        <?php }?>
                     </div>
                  </div>
                  <form id="search-job" action="<?php echo e(url('company/my-jobs')); ?>" method="post">
                  ...
                  <div class="row">   
                     <div class="col-12 col-sm-6 col-xl-4">
                        <div class="form-group">
                           <div class="select-dat">
                              <input type="text" class="form-control" placeholder="<?php echo e(__('messages.START_DATE')); ?>" id="start_date" name="start_date" autocomplete="off" value="<?php echo e(@$search['start_date']); ?>">
                           </div>
                        </div>
                     </div>
                     <div class="col-12 col-sm-6 col-xl-4">
                        <div class="form-group">
                           <div class="select-dat">
                                 <input type="text" class="form-control" placeholder="<?php echo e(__('messages.END_DATE')); ?>" id="end_date" name="end_date" autocomplete="off" value="<?php echo e(@$search['end_date']); ?>">
                     ...
                     <div class="col-12 col-sm-6 col-xl-4">
                        <div class="form-group">
                           <input type="text" class="form-control" placeholder="<?php echo e(__('messages.POSITION_NAME')); ?>" id="title" name="title" value="<?php echo e(@$search['title']); ?>">
                        </div>
                     </div>
                        ...
                        <div class="form-group">
                           ...
                           <select name="city"  id="city" class="form-control select-city-area">
                              ...
                              <?php if($cities){
                                 ...
                                 ?>
                                 <option value="<?php echo e($city->id); ?>" <?php if($city->id == @$search['city']){ echo 'selected';} ?>><?php echo e($city->name); ?></option>
                              <?php  } } ?>
                     ...
                     <div class="col-12 col-sm-6 col-xl-4">
                        <div class="form-group">
                           <select class="form-control" name="status" id="status">
                              <option value="all"> <?php echo e(__('messages.STATUS')); ?></option>
                              <option value="1" <?php if(@$search['status'] == 1 || empty($search['status'])){ echo 'selected';}?>><?php echo e(__('messages.ONGOING')); ?></option>
                              <option value="2" <?php if(@$search['status'] == 2){ echo 'selected';}?>><?php echo e(__('messages.CLOSED')); ?></option>
                              <option value="3" <?php if(@$search['status'] == 3){ echo 'selected';}?>><?php echo e(__('messages.PENDING_PUBLICATION')); ?></option>
                           </select>
                     ...
                     <label class="error error-required-search" style="display:none;"></label>
                        <div class="form-group d-flex">
                           <button class="site-btn btn search-cls mr-2" type="submit"><?php echo e(__('messages.SEARCH')); ?></button>
                           <?php $searchCop = $search ; if(!empty($searchCop) && (isset($searchCop['_token']) && $searchCop['_token'] != '') ){?>
                           <a class="btn site-btn-color" href="<?php echo e(url('company/my-jobs')); ?>"><i class="fa fa-refresh" aria-hidden="true"></i></a>                 
                           <?php } ?><span class="search-refresh-text"> (<?php echo e(__('messages.SEARCH_REFRESH_TEXT')); ?>) </span>
                        </div>
                     </div>
                  </div>
                  </form>
               ...
               <div class="table-responsive job-tbl-cls"> 
                     <table class="table custom-table" id="candidateList">
                        <thead class="custom-thead">
                           <tr>
                                 <th>#<!-- <?php echo e(__('messages.SL_NO')); ?> --></th>
                                ...
                                <!--  <th><?php echo e(__('messages.POSITION')); ?></th> -->
                                 ...
                                 <th><?php echo e(__('messages.START')); ?></th>
                                 <th><?php echo e(__('messages.END')); ?></th>
                                 <th><?php echo e(__('messages.STATUS')); ?></th>
                                 <th><?php echo e(__('messages.TOTAL_APPLICANT')); ?></th>
                        ...
                        <tbody>
                           ...
                           <tr>
                                ...
                                <!--  <td><?php if(count($job['postState']) > 0){ echo $job['postState'][0]['state']['name'];}?></td> -->
                                 ...
                                 <td><?php echo e(date('Y-m-d',strtotime($job['start_date']))); ?></td>
                                 <td><?php echo e(date('Y-m-d',strtotime($job['end_date']))); ?></td>
                                 <td>
                                 ...
                                 <button type="button" class="btn <?php echo e($status_color); ?> btn-lg disable-cursor"><?php echo e($status); ?></button>
                                 </td>
                                 ...
                                 <div class="dropdown">
                                    <button class="btn site-btn-color btn-sm dropdown-toggle" type="button"  data-toggle="dropdown"  id="aaaaa"><?php echo e(__('messages.ACTIONS')); ?> </button>
                                       <ul class="dropdown-menu" id="bag" style="list-style-type: none;">
                                          
                                             <li><a class="dropdown-item" href="<?php echo e(url('company/view-job-post/'.encrypt($job['id']))); ?>"><?php echo e(__('messages.VIEW_POST')); ?></a></li>
                                             <?php if($result == 0){?>
                                             <li><a class="dropdown-item" href="<?php echo e(url('company/edit-job/'.encrypt($job['id']))); ?>"><?php echo e(__('messages.EDIT')); ?></a></li>
                                             <?php }?>
                                             <li><a  href="javascript:void(0);" class="dropdown-item delete_item" data-id="<?php echo e(encrypt($job['id'])); ?>"><?php echo e(__('messages.DELETE')); ?></a></li>
                                             <!-- <li><a href="<?php echo e(url('company/applied-candidates/'.encrypt($job['id']))); ?>" class="dropdown-item"><?php echo e(__('messages.VIEW_APPLICANT')); ?> </a></li> -->
...
<?php $__env->startPush('sub-page-script'); ?>
<script>
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app_after_login_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/centralJobs/resources/views/frontend/company/jobList.blade.php ENDPATH**/ ?>