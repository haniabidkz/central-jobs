                                 ...
                                 <tbody>
                                    <tr>
                                       <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#444;font-size:14px;line-height:150%" valign="top">
                                                   ...
                                                   <tr>
                                                      <td>
                                                         <h1 style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif;color:#444; display:block; font-size:15px; font-weight:600;line-height:1.5; margin:0">
                                                            Sehr geehrte <?php echo $userData['name'];?>,
                                                         </h1>
                                                      </td>
                                          ...
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Vielen Dank für Ihre Kontaktaufnahme!</p>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Ihre Nachricht wurde empfangen.</p>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Wir werden Ihnen bald antworten.</p>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a"><a href="<?php echo e(env('APP_URL')); ?>">Klicken Sie hier</a> um zur Website Central Jobs zu gelangen.</p> 
...
<?php /**PATH /var/www/html/centralJobs/resources/views/email/contactUs.blade.php ENDPATH**/ ?>