                     ...
                     <tbody>
                        <tr>
                           <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#999;font-size:13px;line-height:1.6; padding:20px 0" align="center">
                               <a href="<?php echo e(env('APP_URL')); ?>" target="_blank"><img src="<?php echo e(asset('frontend/images/OFFICIAL_LOGO_emails.jpeg')); ?>" alt="logo" style="max-width: 180px"></a>
                           </td>
                        </tr>
                     </tbody>
                  </table>
                                 ...
                                 <tbody>
                                    <tr>
                                       <td style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif; color:#444;font-size:14px;line-height:150%" valign="top">
                                                   ...
                                                   <tr>
                                                      <td>
                                                         <h1 style="font-family: Verdana,Arial, Helvetica,Tahoma,sans-serif;color:#444; display:block; font-size:15px; font-weight:600;line-height:1.5; margin:0">
                                                            Sehr geehrte <?php echo $userData['first_name'];?>,
                                                         </h1>
                                                      </td>
                                                      <!-- <td width="58" align="right">
                                                         <a href=""><img alt="profile img" src="<?php echo e($userData['imgPath']); ?>" style="height:auto;line-height:100%;outline:none;text-decoration:none;display:inline;width:48px;border-radius:50%;border:0"  width="48" height="48"> </a>
                                                      </td> -->
                                                   </tr>
                                                </tbody>
                                             </table>
                                          ...
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Vielen Dank für die Anmeldung</p>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a">Ihr Konto wurde erfolgreich erstellt, aber Ihre E-Mail-Adresse ist noch nicht verifiziert.</p>
                                          <p style="font-size:14px;line-height:1.7;color:#6a6a6a"><a href="<?php echo e(url('verify-user-email/'.$userData['email_verify_token'])); ?>">Bitte klicken Sie hier</a> um Ihre E-Mail-ID zu verifizieren.</p>
...
<?php /**PATH /var/www/html/centralJobs/resources/views/email/emailVerifyMail.blade.php ENDPATH**/ ?>